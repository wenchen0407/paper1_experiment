...
static void initialize_c4_CoupledTanks_tank_bo
  (SFc4_CoupledTanks_tank_boInstanceStruct *chartInstance);
static void initialize_params_c4_CoupledTanks_tank_bo
  (SFc4_CoupledTanks_tank_boInstanceStruct *chartInstance);
static void enable_c4_CoupledTanks_tank_bo
  (SFc4_CoupledTanks_tank_boInstanceStruct *chartInstance);
static void disable_c4_CoupledTanks_tank_bo
  (SFc4_CoupledTanks_tank_boInstanceStruct *chartInstance);
static void c4_update_debugger_state_c4_CoupledTanks_tank_bo
  (SFc4_CoupledTanks_tank_boInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c4_CoupledTanks_tank_bo
  (SFc4_CoupledTanks_tank_boInstanceStruct *chartInstance);
static void set_sim_state_c4_CoupledTanks_tank_bo
  (SFc4_CoupledTanks_tank_boInstanceStruct *chartInstance, const mxArray *c4_st);
static void finalize_c4_CoupledTanks_tank_bo
  (SFc4_CoupledTanks_tank_boInstanceStruct *chartInstance);
static void sf_c4_CoupledTanks_tank_bo(SFc4_CoupledTanks_tank_boInstanceStruct
  *chartInstance);
static void initSimStructsc4_CoupledTanks_tank_bo
  (SFc4_CoupledTanks_tank_boInstanceStruct *chartInstance);
static void registerMessagesc4_CoupledTanks_tank_bo
  (SFc4_CoupledTanks_tank_boInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c4_machineNumber, uint32_T
  c4_chartNumber);
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData);
static real_T c4_emlrt_marshallIn(SFc4_CoupledTanks_tank_boInstanceStruct
  *chartInstance, const mxArray *c4_b_numAct, const char_T *c4_identifier);
static real_T c4_b_emlrt_marshallIn(SFc4_CoupledTanks_tank_boInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_b_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static void c4_c_emlrt_marshallIn(SFc4_CoupledTanks_tank_boInstanceStruct
  *chartInstance, const mxArray *c4_b_uin_all, const char_T *c4_identifier,
  real_T c4_y[20002]);
static void c4_d_emlrt_marshallIn(SFc4_CoupledTanks_tank_boInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId,
  real_T c4_y[20002]);
...
static const mxArray *c4_c_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static void c4_e_emlrt_marshallIn(SFc4_CoupledTanks_tank_boInstanceStruct
  *chartInstance, const mxArray *c4_b_delay, const char_T *c4_identifier, real_T
  c4_y[15]);
static void c4_f_emlrt_marshallIn(SFc4_CoupledTanks_tank_boInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId,
  real_T c4_y[15]);
...
static const mxArray *c4_d_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static void c4_g_emlrt_marshallIn(SFc4_CoupledTanks_tank_boInstanceStruct
  *chartInstance, const mxArray *c4_b_uin, const char_T *c4_identifier, real_T
  c4_y[2]);
static void c4_h_emlrt_marshallIn(SFc4_CoupledTanks_tank_boInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId,
  real_T c4_y[2]);
...
static const mxArray *c4_e_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static void c4_i_emlrt_marshallIn(SFc4_CoupledTanks_tank_boInstanceStruct
  *chartInstance, const mxArray *c4_b_uin_d, const char_T *c4_identifier, real_T
  c4_y[2]);
static void c4_j_emlrt_marshallIn(SFc4_CoupledTanks_tank_boInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId,
  real_T c4_y[2]);
...
static const mxArray *c4_f_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static void c4_k_emlrt_marshallIn(SFc4_CoupledTanks_tank_boInstanceStruct
  *chartInstance, const mxArray *c4_uout_delay, const char_T *c4_identifier,
  real_T c4_y[2]);
static void c4_l_emlrt_marshallIn(SFc4_CoupledTanks_tank_boInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId,
  real_T c4_y[2]);
...
static const mxArray *c4_h_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static real_T c4_m_emlrt_marshallIn(SFc4_CoupledTanks_tank_boInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
...
static const mxArray *c4_i_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int32_T c4_n_emlrt_marshallIn(SFc4_CoupledTanks_tank_boInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_h_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static uint8_T c4_o_emlrt_marshallIn(SFc4_CoupledTanks_tank_boInstanceStruct
  *chartInstance, const mxArray *c4_b_is_active_c4_CoupledTanks_tank_bo, const
  char_T *c4_identifier);
static uint8_T c4_p_emlrt_marshallIn(SFc4_CoupledTanks_tank_boInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void init_dsm_address_info(SFc4_CoupledTanks_tank_boInstanceStruct
  *chartInstance);
  ...
  (SFc4_CoupledTanks_tank_boInstanceStruct *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_CoupledTanks_tank_bo = 0U;
}
  ...
  (SFc4_CoupledTanks_tank_boInstanceStruct *chartInstance)
{
  ...
  if (!chartInstance->c4_uin_all_not_empty) {
    ...
    sf_mex_assign(&c4_f_y, sf_mex_create("y", c4_e_u, 0, 0U, 1U, 0U, 2, 10001, 2),
                  FALSE);
  }
  ...
  c4_b_hoistedGlobal = chartInstance->c4_is_active_c4_CoupledTanks_tank_bo;
  ...
  (SFc4_CoupledTanks_tank_boInstanceStruct *chartInstance, const mxArray *c4_st)
{
  ...
  chartInstance->c4_is_active_c4_CoupledTanks_tank_bo = c4_o_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 6)),
     "is_active_c4_CoupledTanks_tank_bo");
  sf_mex_destroy(&c4_u);
  c4_update_debugger_state_c4_CoupledTanks_tank_bo(chartInstance);
  ...
  *chartInstance)
{
  ...
  if (CV_EML_IF(0, 1, 0, !chartInstance->c4_uin_not_empty)) {
    ...
    for (c4_i17 = 0; c4_i17 < 20002; c4_i17++) {
  ...
  while (c4_b_j < 2) {
    ...
    if (CV_EML_IF(0, 1, 1, chartInstance->c4_delay[(int32_T)(real_T)
      ...
      chartInstance->c4_uin[(int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("uin",
        ...
        chartInstance->c4_numAct), 1, 10001, 1, 0) + 10001 * ((int32_T)(real_T)
      ...
      if (CV_EML_IF(0, 1, 2, chartInstance->c4_numAct > 1.0)) {
        ...
        chartInstance->c4_uin[(int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("uin",
          ...
          "numAct-1", chartInstance->c4_numAct - 1.0), 1, 10001, 1, 0) + 10001 *
                                     ((int32_T)(real_T)
          _SFD_EML_ARRAY_BOUNDS_CHECK("uin_all", (int32_T)_SFD_INTEGER_CHECK("j",
          c4_j), 1, 2, 2, 0) - 1)) - 1];
        ...
        chartInstance->c4_uin_all[((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
          ...
          chartInstance->c4_numAct), 1, 10001, 1, 0) + 10001 * ((int32_T)(real_T)
          _SFD_EML_ARRAY_BOUNDS_CHECK("uin_all", (int32_T)_SFD_INTEGER_CHECK("j",
          c4_j), 1, 2, 2, 0) - 1)) - 1] = chartInstance->c4_uin_all[((int32_T)
          (real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("uin_all", (int32_T)
          _SFD_INTEGER_CHECK("numAct-1", chartInstance->c4_numAct - 1.0), 1,
          10001, 1, 0) + 10001 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
          "uin_all", (int32_T)_SFD_INTEGER_CHECK("j", c4_j), 1, 2, 2, 0) - 1)) -
          1];
      }
    }
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  const mxArray *c4_y = NULL;
  SFc4_CoupledTanks_tank_boInstanceStruct *chartInstance;
  chartInstance = (SFc4_CoupledTanks_tank_boInstanceStruct *)chartInstanceVoid;
  ...
  *c4_inData)
{
  ...
  int32_T c4_i26;
  int32_T c4_i27;
  static real_T c4_b_inData[20002];
  int32_T c4_i28;
  int32_T c4_i29;
  int32_T c4_i30;
  real_T c4_u[20002];
  ...
  for (c4_i26 = 0; c4_i26 < 2; c4_i26++) {
    for (c4_i27 = 0; c4_i27 < 10001; c4_i27++) {
      c4_b_inData[c4_i27 + c4_i25] = (*(real_T (*)[20002])c4_inData)[c4_i27 +
        c4_i25];
    }
  ...
  for (c4_i29 = 0; c4_i29 < 2; c4_i29++) {
    for (c4_i30 = 0; c4_i30 < 10001; c4_i30++) {
  ...
  if (!chartInstance->c4_uin_all_not_empty) {
    ...
    sf_mex_assign(&c4_y, sf_mex_create("y", c4_u, 0, 0U, 1U, 0U, 2, 10001, 2),
                  FALSE);
  }
  ...
  real_T c4_y[20002])
{
  ...
  if (mxIsEmpty(c4_u)) {
    ...
    sf_mex_import(c4_parentId, sf_mex_dup(c4_u), c4_dv5, 1, 0, 0U, 1, 0U, 2,
                  10001, 2);
    for (c4_i31 = 0; c4_i31 < 20002; c4_i31++) {
  ...
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData)
{
  ...
  for (c4_i33 = 0; c4_i33 < 2; c4_i33++) {
    for (c4_i34 = 0; c4_i34 < 10001; c4_i34++) {
      (*(real_T (*)[20002])c4_outData)[c4_i34 + c4_i32] = c4_y[c4_i34 + c4_i32];
    }
...
const mxArray *sf_c4_CoupledTanks_tank_bo_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c4_identifier)
{
  ...
  c4_y = c4_p_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_CoupledTanks_tank_bo), &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_CoupledTanks_tank_bo);
  return c4_y;
}
...
void sf_c4_CoupledTanks_tank_bo_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1480988719U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1399528247U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2032411252U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3952549995U);
}

mxArray *sf_c4_CoupledTanks_tank_bo_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("wzmoadnyjMdTVIUetqskKC");
...
mxArray *sf_c4_CoupledTanks_tank_bo_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c4_CoupledTanks_tank_bo(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x7'type','srcId','name','auxInfo'{{M[1],M[5],T\"uout_delay\",},{M[4],M[0],T\"delay\",S'l','i','p'{{M1x2[320 325],M[0],}}},{M[4],M[0],T\"numAct\",S'l','i','p'{{M1x2[334 340],M[0],}}},{M[4],M[0],T\"uin\",S'l','i','p'{{M1x2[316 319],M[0],}}},{M[4],M[0],T\"uin_all\",S'l','i','p'{{M1x2[326 333],M[0],}}},{M[4],M[0],T\"uin_d\",S'l','i','p'{{M1x2[298 303],M[0],}}},{M[8],M[0],T\"is_active_c4_CoupledTanks_tank_bo\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 7, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_CoupledTanks_tank_bo_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc4_CoupledTanks_tank_boInstanceStruct *chartInstance;
    chartInstance = (SFc4_CoupledTanks_tank_boInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1405);
        _SFD_CV_INIT_EML_IF(0,1,0,455,470,-1,681);
        _SFD_CV_INIT_EML_IF(0,1,1,937,957,1015,1246);
        _SFD_CV_INIT_EML_IF(0,1,2,1028,1039,-1,1230);
        _SFD_CV_INIT_EML_FOR(0,1,0,816,829,867);
        _SFD_CV_INIT_EML_FOR(0,1,1,923,933,1250);
...
{
  return "rNLYDOOrSld01ga39L6h8F";
}

static void sf_opaque_initialize_c4_CoupledTanks_tank_bo(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc4_CoupledTanks_tank_boInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c4_CoupledTanks_tank_bo
    ((SFc4_CoupledTanks_tank_boInstanceStruct*) chartInstanceVar);
  initialize_c4_CoupledTanks_tank_bo((SFc4_CoupledTanks_tank_boInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c4_CoupledTanks_tank_bo(void *chartInstanceVar)
{
  enable_c4_CoupledTanks_tank_bo((SFc4_CoupledTanks_tank_boInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c4_CoupledTanks_tank_bo(void *chartInstanceVar)
{
  disable_c4_CoupledTanks_tank_bo((SFc4_CoupledTanks_tank_boInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c4_CoupledTanks_tank_bo(void *chartInstanceVar)
{
  sf_c4_CoupledTanks_tank_bo((SFc4_CoupledTanks_tank_boInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c4_CoupledTanks_tank_bo
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c4_CoupledTanks_tank_bo
    ((SFc4_CoupledTanks_tank_boInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c4_CoupledTanks_tank_bo();/* state var info */
...
extern void sf_internal_set_sim_state_c4_CoupledTanks_tank_bo(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c4_CoupledTanks_tank_bo((SFc4_CoupledTanks_tank_boInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c4_CoupledTanks_tank_bo(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c4_CoupledTanks_tank_bo(S);
}

static void sf_opaque_set_sim_state_c4_CoupledTanks_tank_bo(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c4_CoupledTanks_tank_bo(S, st);
}

static void sf_opaque_terminate_c4_CoupledTanks_tank_bo(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_CoupledTanks_tank_boInstanceStruct*) chartInstanceVar
      )->S;
    ...
    finalize_c4_CoupledTanks_tank_bo((SFc4_CoupledTanks_tank_boInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc4_CoupledTanks_tank_bo((SFc4_CoupledTanks_tank_boInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_CoupledTanks_tank_bo(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c4_CoupledTanks_tank_bo
      ((SFc4_CoupledTanks_tank_boInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c4_CoupledTanks_tank_bo(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(561940929U));
  ssSetChecksum1(S,(2371174379U));
  ssSetChecksum2(S,(2090269129U));
  ssSetChecksum3(S,(1269642079U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c4_CoupledTanks_tank_bo(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_CoupledTanks_tank_bo(SimStruct *S)
{
  SFc4_CoupledTanks_tank_boInstanceStruct *chartInstance;
  chartInstance = (SFc4_CoupledTanks_tank_boInstanceStruct *)utMalloc(sizeof
    (SFc4_CoupledTanks_tank_boInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc4_CoupledTanks_tank_boInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c4_CoupledTanks_tank_bo;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c4_CoupledTanks_tank_bo;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c4_CoupledTanks_tank_bo;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c4_CoupledTanks_tank_bo;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c4_CoupledTanks_tank_bo;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c4_CoupledTanks_tank_bo;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c4_CoupledTanks_tank_bo;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c4_CoupledTanks_tank_bo;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_CoupledTanks_tank_bo;
  chartInstance->chartInfo.mdlStart = mdlStart_c4_CoupledTanks_tank_bo;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c4_CoupledTanks_tank_bo;
...
void c4_CoupledTanks_tank_bo_method_dispatcher(SimStruct *S, int_T method, void *
  data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_CoupledTanks_tank_bo(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_CoupledTanks_tank_bo(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_CoupledTanks_tank_bo(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_CoupledTanks_tank_bo_method_dispatcher.\n"
