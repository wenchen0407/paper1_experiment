...
static const char *c2_debug_family_names[16] = { "kk", "j", "nargin", "nargout",
  "yout", "ydelay", "structure", "yout_delay", "yin", "count", "i", "yin_d",
  "yin_all", "delay1", "delay", "num" };

/* Function Declarations */
static void initialize_c2_SIMUL_step_delay_Embed_integrated
  (SFc2_SIMUL_step_delay_Embed_integratedInstanceStruct *chartInstance);
static void initialize_params_c2_SIMUL_step_delay_Embed_integrated
  (SFc2_SIMUL_step_delay_Embed_integratedInstanceStruct *chartInstance);
static void enable_c2_SIMUL_step_delay_Embed_integrated
  (SFc2_SIMUL_step_delay_Embed_integratedInstanceStruct *chartInstance);
static void disable_c2_SIMUL_step_delay_Embed_integrated
  (SFc2_SIMUL_step_delay_Embed_integratedInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_SIMUL_step_delay_Embed_integrated
  (SFc2_SIMUL_step_delay_Embed_integratedInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_SIMUL_step_delay_Embed_integrated
  (SFc2_SIMUL_step_delay_Embed_integratedInstanceStruct *chartInstance);
static void set_sim_state_c2_SIMUL_step_delay_Embed_integrated
  (SFc2_SIMUL_step_delay_Embed_integratedInstanceStruct *chartInstance, const
   mxArray *c2_st);
static void finalize_c2_SIMUL_step_delay_Embed_integrated
  (SFc2_SIMUL_step_delay_Embed_integratedInstanceStruct *chartInstance);
static void sf_c2_SIMUL_step_delay_Embed_integrated
  (SFc2_SIMUL_step_delay_Embed_integratedInstanceStruct *chartInstance);
static void c2_c2_SIMUL_step_delay_Embed_integrated
  (SFc2_SIMUL_step_delay_Embed_integratedInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static real_T c2_rem(SFc2_SIMUL_step_delay_Embed_integratedInstanceStruct
...
static uint8_T c2_j_emlrt_marshallIn
  (SFc2_SIMUL_step_delay_Embed_integratedInstanceStruct *chartInstance, const
   mxArray *c2_b_is_active_c2_SIMUL_step_delay_Embed_integrated, const char_T
   *c2_name);
  ...
  (SFc2_SIMUL_step_delay_Embed_integratedInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_SIMUL_step_delay_Embed_integrated = 0U;
}

static void initialize_params_c2_SIMUL_step_delay_Embed_integrated
  (SFc2_SIMUL_step_delay_Embed_integratedInstanceStruct *
   chartInstance)
{
  const mxArray *c2_m0 = NULL;
  const mxArray *c2_mxField;
  static c2_struct_PdxT33HwfV13eJoHy5hyaE c2_r0;
   ...
   chartInstance)
{
  ...
  int32_T c2_i4;
  static real_T c2_d_hoistedGlobal[50000];
  int32_T c2_i5;
  static real_T c2_d_u[50000];
  ...
  for (c2_i4 = 0; c2_i4 < 50000; c2_i4 = c2_i4 + 1) {
    c2_d_hoistedGlobal[c2_i4] = chartInstance->c2_delay1[c2_i4];
  }

  for (c2_i5 = 0; c2_i5 < 50000; c2_i5 = c2_i5 + 1) {
  ...
  if (!chartInstance->c2_delay1_not_empty) {
    ...
    sf_mex_assign(&c2_e_y, sf_mex_create("y", &c2_d_u, 0, 0U, 1U, 0U, 2, 10000,
      5));
  }
  ...
  c2_j_hoistedGlobal =
    chartInstance->c2_is_active_c2_SIMUL_step_delay_Embed_integrated;
   ...
   const mxArray *c2_st)
{
  ...
  c2_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 3)),
                        "delay1", c2_dv2);
  for (c2_i14 = 0; c2_i14 < 50000; c2_i14 = c2_i14 + 1) {
  ...
  chartInstance->c2_is_active_c2_SIMUL_step_delay_Embed_integrated =
    ...
    c2_u, 9)), "is_active_c2_SIMUL_step_delay_Embed_integrated");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_SIMUL_step_delay_Embed_integrated(chartInstance);
  ...
  (SFc2_SIMUL_step_delay_Embed_integratedInstanceStruct *chartInstance)
{
  ...
  c2_c2_SIMUL_step_delay_Embed_integrated(chartInstance);
  ...
  (SFc2_SIMUL_step_delay_Embed_integratedInstanceStruct *chartInstance)
{
  ...
  static c2_struct_PdxT33HwfV13eJoHy5hyaE c2_c_hoistedGlobal;
  int32_T c2_i23;
  real_T c2_yout[4];
  int32_T c2_i24;
  real_T c2_ydelay[5];
  static c2_struct_PdxT33HwfV13eJoHy5hyaE c2_b_structure;
  uint32_T c2_debug_family_var_map[16];
  static const char *c2_sv0[16] = { "kk", "j", "nargin", "nargout", "yout",
    "ydelay", "structure", "yout_delay", "yin", "count", "i",
  ...
  int32_T c2_i67;
  int32_T c2_i68;
  static char_T c2_cv4[10] = { 'y', 'o', 'u', 't', '_', 'd', 'e', 'l', 'a', 'y'
  };
  ...
  sf_debug_symbol_scope_add_eml(&chartInstance->c2_count, c2_g_sf_marshall, 9U);
  ...
  if (CV_EML_IF(0, 0, !chartInstance->c2_yin_not_empty)) {
    ...
    _SFD_EML_CALL(0,27);
    for (c2_i28 = 0; c2_i28 < 50000; c2_i28 = c2_i28 + 1) {
  ...
  if (CV_EML_IF(0, 1, c2_rem(chartInstance, chartInstance->c2_i, 4.0) == 0.0)) {
    ...
    c2_i31 = _SFD_EML_ARRAY_BOUNDS_CHECK("delay1", (int32_T)_SFD_INTEGER_CHECK(
      "num", chartInstance->c2_num), 1, 10000, 1, 0) - 1;
    for (c2_i32 = 0; c2_i32 < 5; c2_i32 = c2_i32 + 1) {
      chartInstance->c2_delay1[c2_i31 + 10000 * c2_i32] = c2_ydelay[c2_i32];
    }
  ...
  _SFD_EML_CALL(0,43);
  for (c2_i33 = 0; c2_i33 < 5; c2_i33 = c2_i33 + 1) {
  ...
  _SFD_EML_CALL(0,44);
  c2_d_hoistedGlobal = chartInstance->c2_count;
  c2_b_u = c2_d_hoistedGlobal;
  c2_b_y = NULL;
  ...
  /*  disp(delay1) */
  _SFD_EML_CALL(0,49);
  for (c2_i34 = 0; c2_i34 < 5; c2_i34 = c2_i34 + 1) {
    c2_c_u[c2_i34] = c2_cv1[c2_i34];
  }
  ...
  _SFD_EML_CALL(0,50);
  for (c2_i35 = 0; c2_i35 < 5; c2_i35 = c2_i35 + 1) {
    c2_e_hoistedGlobal[c2_i35] = chartInstance->c2_delay[c2_i35];
  }

  for (c2_i36 = 0; c2_i36 < 5; c2_i36 = c2_i36 + 1) {
    c2_d_u[c2_i36] = c2_e_hoistedGlobal[c2_i36];
  }
  ...
  if (CV_EML_IF(0, 2, c2_rem(chartInstance, chartInstance->c2_i, 40.0) == 16.0))
  {
    ...
    if (CV_EML_IF(0, 3, chartInstance->c2_delay[1] != 88.0)) {
      ...
      for (c2_i38 = 0; c2_i38 < 4; c2_i38 = c2_i38 + 1) {
        c2_f_hoistedGlobal[c2_i38] = chartInstance->c2_yin[c2_i38];
      }

      for (c2_i39 = 0; c2_i39 < 4; c2_i39 = c2_i39 + 1) {
        c2_f_u[c2_i39] = c2_f_hoistedGlobal[c2_i39];
      }
    ...
    for (c2_i40 = 0; c2_i40 < 4; c2_i40 = c2_i40 + 1) {
      chartInstance->c2_yin_d[c2_i40] = chartInstance->c2_yin[c2_i40];
    }

    _SFD_EML_CALL(0,60);
    for (c2_i41 = 0; c2_i41 < 5; c2_i41 = c2_i41 + 1) {
      c2_g_u[c2_i41] = c2_cv3[c2_i41];
    }
    ...
    for (c2_i42 = 0; c2_i42 < 4; c2_i42 = c2_i42 + 1) {
      c2_g_hoistedGlobal[c2_i42] = chartInstance->c2_yin_d[c2_i42];
    }

    for (c2_i43 = 0; c2_i43 < 4; c2_i43 = c2_i43 + 1) {
      c2_h_u[c2_i43] = c2_g_hoistedGlobal[c2_i43];
    }
  ...
  if (CV_EML_IF(0, 4, c2_rem(chartInstance, chartInstance->c2_i, 40.0) == 24.0))
  {
    ...
    if (CV_EML_IF(0, 5, chartInstance->c2_delay[2] != 88.0)) {
      ...
      for (c2_i45 = 0; c2_i45 < 4; c2_i45 = c2_i45 + 1) {
        c2_h_hoistedGlobal[c2_i45] = chartInstance->c2_yin[c2_i45];
      }

      for (c2_i46 = 0; c2_i46 < 4; c2_i46 = c2_i46 + 1) {
        c2_j_u[c2_i46] = c2_h_hoistedGlobal[c2_i46];
      }
    ...
    for (c2_i47 = 0; c2_i47 < 4; c2_i47 = c2_i47 + 1) {
      chartInstance->c2_yin_d[c2_i47] = chartInstance->c2_yin[c2_i47];
    }

    _SFD_EML_CALL(0,72);
    for (c2_i48 = 0; c2_i48 < 5; c2_i48 = c2_i48 + 1) {
      c2_k_u[c2_i48] = c2_cv3[c2_i48];
    }
    ...
    for (c2_i49 = 0; c2_i49 < 4; c2_i49 = c2_i49 + 1) {
      c2_i_hoistedGlobal[c2_i49] = chartInstance->c2_yin_d[c2_i49];
    }

    for (c2_i50 = 0; c2_i50 < 4; c2_i50 = c2_i50 + 1) {
      c2_l_u[c2_i50] = c2_i_hoistedGlobal[c2_i50];
    }
  ...
  if (CV_EML_IF(0, 6, c2_rem(chartInstance, chartInstance->c2_i, 40.0) == 32.0))
  {
    ...
    if (CV_EML_IF(0, 7, chartInstance->c2_delay[3] != 88.0)) {
      ...
      for (c2_i52 = 0; c2_i52 < 4; c2_i52 = c2_i52 + 1) {
        c2_j_hoistedGlobal[c2_i52] = chartInstance->c2_yin[c2_i52];
      }

      for (c2_i53 = 0; c2_i53 < 4; c2_i53 = c2_i53 + 1) {
        c2_n_u[c2_i53] = c2_j_hoistedGlobal[c2_i53];
      }
    ...
    for (c2_i54 = 0; c2_i54 < 4; c2_i54 = c2_i54 + 1) {
      chartInstance->c2_yin_d[c2_i54] = chartInstance->c2_yin[c2_i54];
    }

    _SFD_EML_CALL(0,84);
    for (c2_i55 = 0; c2_i55 < 5; c2_i55 = c2_i55 + 1) {
      c2_o_u[c2_i55] = c2_cv3[c2_i55];
    }
    ...
    for (c2_i56 = 0; c2_i56 < 4; c2_i56 = c2_i56 + 1) {
      c2_k_hoistedGlobal[c2_i56] = chartInstance->c2_yin_d[c2_i56];
    }

    for (c2_i57 = 0; c2_i57 < 4; c2_i57 = c2_i57 + 1) {
      c2_p_u[c2_i57] = c2_k_hoistedGlobal[c2_i57];
    }
    ...
    if (CV_EML_COND(0, 1, chartInstance->c2_i != 0.0)) {
      ...
      if (CV_EML_IF(0, 9, chartInstance->c2_delay[4] != 88.0)) {
        ...
        for (c2_i59 = 0; c2_i59 < 4; c2_i59 = c2_i59 + 1) {
          c2_l_hoistedGlobal[c2_i59] = chartInstance->c2_yin[c2_i59];
        }

        for (c2_i60 = 0; c2_i60 < 4; c2_i60 = c2_i60 + 1) {
          c2_r_u[c2_i60] = c2_l_hoistedGlobal[c2_i60];
        }
      ...
      for (c2_i61 = 0; c2_i61 < 4; c2_i61 = c2_i61 + 1) {
        chartInstance->c2_yin_d[c2_i61] = chartInstance->c2_yin[c2_i61];
      }

      _SFD_EML_CALL(0,96);
      for (c2_i62 = 0; c2_i62 < 5; c2_i62 = c2_i62 + 1) {
        c2_s_u[c2_i62] = c2_cv3[c2_i62];
      }
      ...
      for (c2_i63 = 0; c2_i63 < 4; c2_i63 = c2_i63 + 1) {
        c2_m_hoistedGlobal[c2_i63] = chartInstance->c2_yin_d[c2_i63];
      }

      for (c2_i64 = 0; c2_i64 < 4; c2_i64 = c2_i64 + 1) {
        c2_t_u[c2_i64] = c2_m_hoistedGlobal[c2_i64];
      }
      ...
      _SFD_EML_CALL(0,99);
      c2_i65 = _SFD_EML_ARRAY_BOUNDS_CHECK("delay1", (int32_T)_SFD_INTEGER_CHECK
        ("count", chartInstance->c2_count), 1, 10000, 1, 0) - 1;
      for (c2_i66 = 0; c2_i66 < 5; c2_i66 = c2_i66 + 1) {
        chartInstance->c2_delay[c2_i66] = chartInstance->c2_delay1[c2_i65 +
          10000 * c2_i66];
      }
 ...
 label_1:
  ...
  for (c2_i67 = 0; c2_i67 < 4; c2_i67 = c2_i67 + 1) {
    c2_yout_delay[c2_i67] = chartInstance->c2_yin_d[c2_i67];
  }

  _SFD_EML_CALL(0,104);
  for (c2_i68 = 0; c2_i68 < 10; c2_i68 = c2_i68 + 1) {
    c2_u_u[c2_i68] = c2_cv4[c2_i68];
  }

  c2_u_y = NULL;
  sf_mex_assign(&c2_u_y, sf_mex_create("y", &c2_u_u, 10, 0U, 1U, 0U, 2, 1, 10));
  sf_mex_call_debug("disp", 0U, 1U, 14, c2_u_y);
  _SFD_EML_CALL(0,105);
  for (c2_i69 = 0; c2_i69 < 4; c2_i69 = c2_i69 + 1) {
    c2_v_u[c2_i69] = c2_yout_delay[c2_i69];
  }

  c2_v_y = NULL;
  sf_mex_assign(&c2_v_y, sf_mex_create("y", &c2_v_u, 0, 0U, 1U, 0U, 2, 1, 4));
  ...
  _SFD_EML_CALL(0,109);
  c2_n_hoistedGlobal = chartInstance->c2_i;
  ...
  for (c2_i70 = 0; c2_i70 < 4; c2_i70 = c2_i70 + 1) {
    (*c2_b_yout_delay)[c2_i70] = c2_yout_delay[c2_i70];
  }
...
static const mxArray *c2_sf_marshall(void *chartInstanceVoid, void *c2_u)
{
  ...
  const mxArray *c2_b_y = NULL;
  SFc2_SIMUL_step_delay_Embed_integratedInstanceStruct *chartInstance;
  chartInstance = (SFc2_SIMUL_step_delay_Embed_integratedInstanceStruct *)
    chartInstanceVoid;
  c2_y = NULL;
  c2_b_u = *((real_T *)c2_u);
  c2_b_y = NULL;
...
static const mxArray *c2_b_sf_marshall(void *chartInstanceVoid, void *c2_u)
{
  ...
  for (c2_i71 = 0; c2_i71 < 5; c2_i71 = c2_i71 + 1) {
    c2_b_u[c2_i71] = (*((real_T (*)[5])c2_u))[c2_i71];
  }
...
static const mxArray *c2_c_sf_marshall(void *chartInstanceVoid, void *c2_u)
{
  ...
  c2_y = NULL;
  c2_i72 = 0;
  for (c2_i73 = 0; c2_i73 < 5; c2_i73 = c2_i73 + 1) {
    for (c2_i74 = 0; c2_i74 < 10000; c2_i74 = c2_i74 + 1) {
      c2_b_u[c2_i74 + c2_i72] = (*((real_T (*)[50000])c2_u))[c2_i74 + c2_i72];
    }
  ...
  if (!chartInstance->c2_delay1_not_empty) {
    ...
    sf_mex_assign(&c2_b_y, sf_mex_create("y", &c2_b_u, 0, 0U, 1U, 0U, 2, 10000,
      5));
  }
...
static const mxArray *c2_d_sf_marshall(void *chartInstanceVoid, void *c2_u)
{
  ...
  for (c2_i76 = 0; c2_i76 < 4; c2_i76 = c2_i76 + 1) {
    for (c2_i77 = 0; c2_i77 < 10001; c2_i77 = c2_i77 + 1) {
      c2_b_u[c2_i77 + c2_i75] = (*((real_T (*)[40004])c2_u))[c2_i77 + c2_i75];
    }
...
{
  const mxArray *c2_y = NULL;
  static c2_struct_PdxT33HwfV13eJoHy5hyaE c2_b_u;
  const mxArray *c2_b_y = NULL;
  real_T c2_c_u;
  const mxArray *c2_c_y = NULL;
  real_T c2_d_u;
  ...
  chartInstance = (SFc2_SIMUL_step_delay_Embed_integratedInstanceStruct *)
    chartInstanceVoid;
  c2_y = NULL;
  c2_b_u = *((c2_struct_PdxT33HwfV13eJoHy5hyaE *)c2_u);
  c2_b_y = NULL;
  ...
  for (c2_i81 = 0; c2_i81 < 4; c2_i81 = c2_i81 + 1) {
    c2_e_u[c2_i81] = c2_b_u.yin[c2_i81];
  }
  ...
  for (c2_i82 = 0; c2_i82 < 4; c2_i82 = c2_i82 + 1) {
    c2_f_u[c2_i82] = c2_b_u.yin_d[c2_i82];
  }

  c2_f_y = NULL;
  sf_mex_assign(&c2_f_y, sf_mex_create("y", &c2_f_u, 0, 0U, 1U, 0U, 2, 4, 1));
  sf_mex_addfield(c2_b_y, c2_f_y, "yin_d", "yin_d", 0);
  for (c2_i83 = 0; c2_i83 < 50000; c2_i83 = c2_i83 + 1) {
    c2_g_u[c2_i83] = c2_b_u.delay1[c2_i83];
  }

  c2_g_y = NULL;
  sf_mex_assign(&c2_g_y, sf_mex_create("y", &c2_g_u, 0, 0U, 1U, 0U, 2, 10000, 5));
  sf_mex_addfield(c2_b_y, c2_g_y, "delay1", "delay1", 0);
  for (c2_i84 = 0; c2_i84 < 4; c2_i84 = c2_i84 + 1) {
    c2_h_u[c2_i84] = c2_b_u.ranD[c2_i84];
  }
...
static const mxArray *c2_k_sf_marshall(void *chartInstanceVoid, void *c2_u)
{
  ...
  chartInstance = (SFc2_SIMUL_step_delay_Embed_integratedInstanceStruct *)
    chartInstanceVoid;
  c2_y = NULL;
  for (c2_i85 = 0; c2_i85 < 5; c2_i85 = c2_i85 + 1) {
    c2_b_u[c2_i85] = (*((real_T (*)[5])c2_u))[c2_i85];
  }
...
const mxArray
  *sf_c2_SIMUL_step_delay_Embed_integrated_get_eml_resolved_functions_info(void)
{
  ...
  for (c2_i86 = 0; c2_i86 < 20; c2_i86 = c2_i86 + 1) {
    ...
    sf_mex_addfield(c2_m1, sf_mex_create("nameCaptureInfo", c2_r1->dominantType,
      15, 0U, 0U, 0U, 2, 1, strlen(c2_r1->dominantType)),
                    "dominantType", "nameCaptureInfo", c2_i86);
    ...
    sf_mex_addfield(c2_m1, sf_mex_create("nameCaptureInfo", &c2_r1->fileTime1, 7,
      0U, 0U, 0U, 0), "fileTime1", "nameCaptureInfo", c2_i86
                    );
    sf_mex_addfield(c2_m1, sf_mex_create("nameCaptureInfo", &c2_r1->fileTime2, 7,
      0U, 0U, 0U, 0), "fileTime2", "nameCaptureInfo", c2_i86
                    );
  }
...
static const mxArray *c2_n_sf_marshall(void *chartInstanceVoid, void *c2_u)
{
  ...
  for (c2_i87 = 0; c2_i87 < 4; c2_i87 = c2_i87 + 1) {
    c2_b_u[c2_i87] = (*((real_T (*)[4])c2_u))[c2_i87];
  }
   ...
   const char_T *c2_name, real_T c2_y[5])
{
  ...
  if (mxIsEmpty(c2_b_delay)) {
    ...
    sf_mex_import(c2_name, sf_mex_dup(c2_b_delay), &c2_dv7, 1, 0, 0U, 1, 0U, 2,
                  1, 5);
    for (c2_i89 = 0; c2_i89 < 5; c2_i89 = c2_i89 + 1) {
      c2_y[c2_i89] = c2_dv7[c2_i89];
    }
  }
...
static void c2_d_emlrt_marshallIn
  (SFc2_SIMUL_step_delay_Embed_integratedInstanceStruct *chartInstance, const
   mxArray *c2_b_delay1,
   const char_T *c2_name, real_T c2_y[50000])
{
  static real_T c2_dv8[50000];
  int32_T c2_i90;
  if (mxIsEmpty(c2_b_delay1)) {
    ...
    sf_mex_import(c2_name, sf_mex_dup(c2_b_delay1), &c2_dv8, 1, 0, 0U, 1, 0U, 2,
                  10000, 5);
    for (c2_i90 = 0; c2_i90 < 50000; c2_i90 = c2_i90 + 1) {
      c2_y[c2_i90] = c2_dv8[c2_i90];
    }
  }
...
static void c2_h_emlrt_marshallIn
  (SFc2_SIMUL_step_delay_Embed_integratedInstanceStruct *chartInstance, const
   mxArray *c2_b_yin_all,
   const char_T *c2_name, real_T c2_y[40004])
{
  ...
  if (mxIsEmpty(c2_b_yin_all)) {
    ...
    sf_mex_import(c2_name, sf_mex_dup(c2_b_yin_all), &c2_dv10, 1, 0, 0U, 1, 0U,
                  2, 10001, 4);
    for (c2_i92 = 0; c2_i92 < 40004; c2_i92 = c2_i92 + 1) {
      c2_y[c2_i92] = c2_dv10[c2_i92];
    }
  }
...
static uint8_T c2_j_emlrt_marshallIn
  (SFc2_SIMUL_step_delay_Embed_integratedInstanceStruct *chartInstance, const
   mxArray *
   c2_b_is_active_c2_SIMUL_step_delay_Embed_integrated, const char_T *c2_name)
{
  uint8_T c2_y;
  uint8_T c2_u0;
  sf_mex_import(c2_name, sf_mex_dup
                (c2_b_is_active_c2_SIMUL_step_delay_Embed_integrated), &c2_u0, 1,
                3, 0U, 0, 0U, 0);
  c2_y = c2_u0;
  sf_mex_destroy(&c2_b_is_active_c2_SIMUL_step_delay_Embed_integrated);
  return c2_y;
}
...
/* SFunction Glue Code */
void sf_c2_SIMUL_step_delay_Embed_integrated_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3138541160U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(352776586U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3857328593U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2501045172U);
}

mxArray *sf_c2_SIMUL_step_delay_Embed_integrated_get_autoinheritance_info(void)
{
...

  {
    ...
    pr[0] = (double)(813913933U);
    pr[1] = (double)(1758488917U);
    pr[2] = (double)(1754578166U);
    pr[3] = (double)(3581439674U);
...
static mxArray *sf_get_sim_state_info_c2_SIMUL_step_delay_Embed_integrated(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[5],T\"yout_delay\",},{M[4],M[0],T\"count\",S'l','i','p'{{M1x2[337 342],M[0],}}},{M[4],M[0],T\"delay\",S'l','i','p'{{M1x2[343 348],M[0],}}},{M[4],M[0],T\"delay1\",S'l','i','p'{{M1x2[307 313],M[0],}}},{M[4],M[0],T\"i\",S'l','i','p'{{M1x2[314 315],M[0],}}},{M[4],M[0],T\"num\",S'l','i','p'{{M1x2[357 360],M[0],}}},{M[4],M[0],T\"yin\",S'l','i','p'{{M1x2[333 336],M[0],}}},{M[4],M[0],T\"yin_all\",S'l','i','p'{{M1x2[349 356],M[0],}}},{M[4],M[0],T\"yin_d\",S'l','i','p'{{M1x2[316 321],M[0],}}},{M[8],M[0],T\"is_active_c2_SIMUL_step_delay_Embed_integrated\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 10, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_SIMUL_step_delay_Embed_integrated_get_check_sum(&mxChecksum);
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,2103);
        _SFD_CV_INIT_EML_IF(0,0,410,425,-1,698);
        _SFD_CV_INIT_EML_IF(0,1,811,825,-1,936);
        _SFD_CV_INIT_EML_IF(0,2,1051,1067,-1,1268);
        _SFD_CV_INIT_EML_IF(0,3,1112,1131,-1,1212);
        _SFD_CV_INIT_EML_IF(0,4,1270,1286,-1,1487);
        _SFD_CV_INIT_EML_IF(0,5,1331,1350,-1,1431);
        _SFD_CV_INIT_EML_IF(0,6,1489,1505,-1,1706);
        _SFD_CV_INIT_EML_IF(0,7,1550,1569,-1,1650);
        _SFD_CV_INIT_EML_IF(0,8,1708,1731,-1,1982);
        _SFD_CV_INIT_EML_IF(0,9,1776,1795,-1,1876);
        _SFD_CV_INIT_EML_FOR(0,0,876,889,932);

        {
          static int condStart[] = { 1711, 1727 };

          static int condEnd[] = { 1723, 1731 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,0,1711,1731,2,0,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }
...
static void sf_opaque_initialize_c2_SIMUL_step_delay_Embed_integrated(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc2_SIMUL_step_delay_Embed_integratedInstanceStruct*) chartInstanceVar
     )->S,0);
  initialize_params_c2_SIMUL_step_delay_Embed_integrated
    ((SFc2_SIMUL_step_delay_Embed_integratedInstanceStruct*) chartInstanceVar);
  initialize_c2_SIMUL_step_delay_Embed_integrated
    ((SFc2_SIMUL_step_delay_Embed_integratedInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_SIMUL_step_delay_Embed_integrated(void
  *chartInstanceVar)
{
  enable_c2_SIMUL_step_delay_Embed_integrated
    ((SFc2_SIMUL_step_delay_Embed_integratedInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_SIMUL_step_delay_Embed_integrated(void
  *chartInstanceVar)
{
  disable_c2_SIMUL_step_delay_Embed_integrated
    ((SFc2_SIMUL_step_delay_Embed_integratedInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_SIMUL_step_delay_Embed_integrated(void
  *chartInstanceVar)
{
  sf_c2_SIMUL_step_delay_Embed_integrated
    ((SFc2_SIMUL_step_delay_Embed_integratedInstanceStruct*) chartInstanceVar);
}

static mxArray* sf_internal_get_sim_state_c2_SIMUL_step_delay_Embed_integrated
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_SIMUL_step_delay_Embed_integrated
    ((SFc2_SIMUL_step_delay_Embed_integratedInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = sf_get_sim_state_info_c2_SIMUL_step_delay_Embed_integrated();/* state var info */
...
static void sf_internal_set_sim_state_c2_SIMUL_step_delay_Embed_integrated
  (SimStruct* S, const mxArray *st)
{
  ...
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c2_SIMUL_step_delay_Embed_integrated();/* state var info */
  mxError = sf_mex_call_matlab(1, plhs, 4, prhs, "sfprivate");
  mxDestroyArray(prhs[0]);
  mxDestroyArray(prhs[1]);
  mxDestroyArray(prhs[2]);
  ...
  set_sim_state_c2_SIMUL_step_delay_Embed_integrated
    ((SFc2_SIMUL_step_delay_Embed_integratedInstanceStruct*)
     chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static mxArray* sf_opaque_get_sim_state_c2_SIMUL_step_delay_Embed_integrated
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c2_SIMUL_step_delay_Embed_integrated(S);
}

static void sf_opaque_set_sim_state_c2_SIMUL_step_delay_Embed_integrated
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c2_SIMUL_step_delay_Embed_integrated(S, st);
}

static void sf_opaque_terminate_c2_SIMUL_step_delay_Embed_integrated(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_SIMUL_step_delay_Embed_integratedInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c2_SIMUL_step_delay_Embed_integrated
      ((SFc2_SIMUL_step_delay_Embed_integratedInstanceStruct*) chartInstanceVar);
...
static void mdlProcessParameters_c2_SIMUL_step_delay_Embed_integrated(SimStruct *
  S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c2_SIMUL_step_delay_Embed_integrated
      ((SFc2_SIMUL_step_delay_Embed_integratedInstanceStruct*)(((ChartInfoStruct
          *)ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_SIMUL_step_delay_Embed_integrated(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(282247379U));
  ssSetChecksum1(S,(1369844305U));
  ssSetChecksum2(S,(3917616078U));
  ssSetChecksum3(S,(771904500U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c2_SIMUL_step_delay_Embed_integrated(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_SIMUL_step_delay_Embed_integrated(SimStruct *S)
{
  SFc2_SIMUL_step_delay_Embed_integratedInstanceStruct *chartInstance;
  chartInstance = (SFc2_SIMUL_step_delay_Embed_integratedInstanceStruct *)malloc
    (sizeof(SFc2_SIMUL_step_delay_Embed_integratedInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_SIMUL_step_delay_Embed_integrated;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_SIMUL_step_delay_Embed_integrated;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_SIMUL_step_delay_Embed_integrated;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_SIMUL_step_delay_Embed_integrated;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_SIMUL_step_delay_Embed_integrated;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_SIMUL_step_delay_Embed_integrated;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_SIMUL_step_delay_Embed_integrated;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_SIMUL_step_delay_Embed_integrated;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_SIMUL_step_delay_Embed_integrated;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c2_SIMUL_step_delay_Embed_integrated;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_SIMUL_step_delay_Embed_integrated;
...
void c2_SIMUL_step_delay_Embed_integrated_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_SIMUL_step_delay_Embed_integrated(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_SIMUL_step_delay_Embed_integrated(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_SIMUL_step_delay_Embed_integrated(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_SIMUL_step_delay_Embed_integrated_method_dispatcher.\n"
