...
static const mxArray *c1_g_sf_marshallOut(void *chartInstanceVoid, real_T
  c1_inData_data[5], int32_T c1_inData_sizes[2]);
static void c1_j_emlrt_marshallIn
  (SFc1_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance, const
   mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y_data[5],
   int32_T c1_y_sizes[2]);
static void c1_g_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, real_T c1_outData_data[5],
  ...
  (SFc1_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance)
{
  ...
  int32_T c1_emergency_instance_sizes[2];
  real_T c1_emergency_instance_data[5];
  ...
  int32_T c1_i13;
  int32_T c1_b_emergency_instance;
  int32_T c1_c_emergency_instance;
  int32_T c1_i14;
  int32_T c1_i15;
  ...
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 12U, 13U, c1_debug_family_names,
    c1_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c1_emergency_instance, MAX_uint32_T,
    c1_i_sf_marshallOut, c1_h_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_result, 1U, c1_h_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_status, 2U, c1_h_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_delay, 3U, c1_h_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_DYN_IMPORTABLE(c1_emergency_instance_data, (const
    int32_T *)&c1_emergency_instance_sizes, NULL, 0, -1, (void *)
    c1_g_sf_marshallOut, (void *)c1_g_sf_marshallIn);
  ...
  c1_emergency_instance_sizes[0] = 1;
  c1_emergency_instance_sizes[1] = 5;
  c1_b_emergency_instance = c1_emergency_instance_sizes[0];
  c1_c_emergency_instance = c1_emergency_instance_sizes[1];
  for (c1_i14 = 0; c1_i14 < 5; c1_i14++) {
    c1_emergency_instance_data[c1_i14] = 1.0;
  }
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  for (c1_i23 = 0; c1_i23 < 10; c1_i23++) {
    c1_b_inData[c1_i23] = (*(real_T (*)[10])c1_inData)[c1_i23];
  }
  ...
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData)
{
  ...
  c1_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c1_b_last_emergency_instance),
                        &c1_thisId, c1_y);
  sf_mex_destroy(&c1_b_last_emergency_instance);
  for (c1_i26 = 0; c1_i26 < 10; c1_i26++) {
    (*(real_T (*)[10])c1_outData)[c1_i26] = c1_y[c1_i26];
  }
  ...
  *c1_inData)
{
  ...
  chartInstance = (SFc1_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *)
    chartInstanceVoid;
  c1_mxArrayOutData = NULL;
  for (c1_i34 = 0; c1_i34 < 10; c1_i34++) {
    c1_b_inData[c1_i34] = (*(real_T (*)[10])c1_inData)[c1_i34];
  }

  for (c1_i35 = 0; c1_i35 < 10; c1_i35++) {
  ...
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData)
{
  ...
  for (c1_i37 = 0; c1_i37 < 10; c1_i37++) {
    (*(real_T (*)[10])c1_outData)[c1_i37] = c1_y[c1_i37];
  }
  ...
  c1_inData_data[5], int32_T c1_inData_sizes[2])
{
  ...
  c1_b_inData_sizes[1] = 5;
  for (c1_i38 = 0; c1_i38 < 5; c1_i38++) {
    c1_b_inData_data[c1_b_inData_sizes[0] * c1_i38] =
      c1_inData_data[c1_inData_sizes[0] * c1_i38];
  }

  c1_u_sizes[0] = 1;
  c1_u_sizes[1] = 5;
  for (c1_i39 = 0; c1_i39 < 5; c1_i39++) {
    c1_u_data[c1_u_sizes[0] * c1_i39] = c1_b_inData_data[c1_b_inData_sizes[0] *
      c1_i39];
  }
   ...
   int32_T c1_y_sizes[2])
{
  ...
  for (c1_i40 = 0; c1_i40 < 2; c1_i40++) {
    c1_uv0[c1_i40] = 1U + ((uint32_T)c1_i40 << 2);
  }
  ...
  int32_T c1_outData_sizes[2])
{
  ...
  c1_j_emlrt_marshallIn(chartInstance, sf_mex_dup(c1_emergency_instance),
                        &c1_thisId, c1_y_data, c1_y_sizes);
  sf_mex_destroy(&c1_emergency_instance);
  c1_outData_sizes[0] = 1;
  c1_outData_sizes[1] = 5;
  for (c1_i43 = 0; c1_i43 < 5; c1_i43++) {
    c1_outData_data[c1_outData_sizes[0] * c1_i43] = c1_y_data[c1_y_sizes[0] *
      c1_i43];
  }
   ...
   mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[15])
{
  ...
  for (c1_i48 = 0; c1_i48 < 15; c1_i48++) {
    c1_y[c1_i48] = c1_dv10[c1_i48];
  }
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1315568432U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2753746936U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3416417864U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3852130120U);
}
...
mxArray *sf_c1_CoupledTanks_WCPS_v2_DoubleSD_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("VVoscAFtGqfr0J3t6CMdbF");
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1625);
...
static void mdlSetWorkWidths_c1_CoupledTanks_WCPS_v2_DoubleSD(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(550297766U));
  ssSetChecksum1(S,(4073278500U));
  ssSetChecksum2(S,(1117609662U));
  ssSetChecksum3(S,(3155210344U));
