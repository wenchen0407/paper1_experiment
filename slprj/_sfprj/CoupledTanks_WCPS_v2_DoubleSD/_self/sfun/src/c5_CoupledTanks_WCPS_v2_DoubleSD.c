...
static void c5_h_emlrt_marshallIn
  (SFc5_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance, const
   mxArray *c5_transpose, const char_T *c5_identifier, real_T c5_y[15]);
  ...
  (SFc5_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance)
{
  ...
  int32_T c5_i7;
  int32_T c5_i8;
  static char_T c5_cv0[17] = { 't', 'o', 's', 's', 'i', 'm', '-', 'c', 'a', 'l',
    'l', '-', 'p', 's', '.', 'p', 'y' };
  ...
  c5_y = NULL;
  sf_mex_assign(&c5_y, sf_mex_create("y", c5_u, 10, 0U, 1U, 0U, 2, 1, 17), FALSE);
  c5_b_u = -74.0;
  c5_b_y = NULL;
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(974782001U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(17047426U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2416149776U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(712915126U);
}
...
mxArray *sf_c5_CoupledTanks_WCPS_v2_DoubleSD_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("UgeAYFZpZd5QoOg8dpm2P");
...
static void mdlSetWorkWidths_c5_CoupledTanks_WCPS_v2_DoubleSD(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1570762057U));
  ssSetChecksum1(S,(2463045043U));
  ssSetChecksum2(S,(4143471659U));
  ssSetChecksum3(S,(2806001892U));
