...
static void c4_c_emlrt_marshallIn
  (SFc4_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance, const
   mxArray *c4_b_uin_all, const char_T *c4_identifier, real_T c4_y[20002]);
static void c4_d_emlrt_marshallIn
  (SFc4_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance, const
   mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId, real_T c4_y[20002]);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1329755347U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3803958025U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3610178347U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3760686353U);
}
...
mxArray *sf_c4_CoupledTanks_WCPS_v2_DoubleSD_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("zQPTyEe2CfP373RDFfDpe");
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1438);
        _SFD_CV_INIT_EML_IF(0,1,0,459,474,-1,695);
...
static void mdlSetWorkWidths_c4_CoupledTanks_WCPS_v2_DoubleSD(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(4009033758U));
  ssSetChecksum1(S,(462378101U));
  ssSetChecksum2(S,(2575436293U));
  ssSetChecksum3(S,(979351272U));
