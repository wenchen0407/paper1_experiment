...
static void c6_c_emlrt_marshallIn
  (SFc6_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance, const
   mxArray *c6_b_uin_all, const char_T *c6_identifier, real_T c6_y[20002]);
static void c6_d_emlrt_marshallIn
  (SFc6_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance, const
   mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId, real_T c6_y[20002]);
  ...
  (SFc6_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance)
{
  ...
  if (!chartInstance->c6_uin_all_not_empty) {
    ...
    sf_mex_assign(&c6_f_y, sf_mex_create("y", c6_e_u, 0, 0U, 1U, 0U, 2, 10001, 2),
                  FALSE);
  }
  ...
  (SFc6_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance)
{
  ...
  if (CV_EML_IF(0, 1, 0, !chartInstance->c6_uin_not_empty)) {
    ...
    for (c6_i17 = 0; c6_i17 < 20002; c6_i17++) {
  ...
  while (c6_b_j < 2) {
    ...
    if (CV_EML_IF(0, 1, 1, chartInstance->c6_delay[(int32_T)(real_T)
      ...
      chartInstance->c6_uin[(int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("uin",
        ...
        chartInstance->c6_numAct), 1, 10001, 1, 0) + 10001 * ((int32_T)(real_T)
      ...
      if (CV_EML_IF(0, 1, 2, chartInstance->c6_numAct > 1.0)) {
        ...
        chartInstance->c6_uin[(int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("uin",
          ...
          "numAct-1", chartInstance->c6_numAct - 1.0), 1, 10001, 1, 0) + 10001 *
                                     ((int32_T)(real_T)
          _SFD_EML_ARRAY_BOUNDS_CHECK("uin_all", (int32_T)_SFD_INTEGER_CHECK("j",
          c6_j), 1, 2, 2, 0) - 1)) - 1];
        ...
        chartInstance->c6_uin_all[((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
          ...
          chartInstance->c6_numAct), 1, 10001, 1, 0) + 10001 * ((int32_T)(real_T)
          _SFD_EML_ARRAY_BOUNDS_CHECK("uin_all", (int32_T)_SFD_INTEGER_CHECK("j",
          c6_j), 1, 2, 2, 0) - 1)) - 1] = chartInstance->c6_uin_all[((int32_T)
          (real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("uin_all", (int32_T)
          _SFD_INTEGER_CHECK("numAct-1", chartInstance->c6_numAct - 1.0), 1,
          10001, 1, 0) + 10001 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
          "uin_all", (int32_T)_SFD_INTEGER_CHECK("j", c6_j), 1, 2, 2, 0) - 1)) -
          1];
      }
    }
  ...
  *c6_inData)
{
  ...
  int32_T c6_i26;
  int32_T c6_i27;
  static real_T c6_b_inData[20002];
  int32_T c6_i28;
  int32_T c6_i29;
  int32_T c6_i30;
  real_T c6_u[20002];
  ...
  for (c6_i26 = 0; c6_i26 < 2; c6_i26++) {
    for (c6_i27 = 0; c6_i27 < 10001; c6_i27++) {
      c6_b_inData[c6_i27 + c6_i25] = (*(real_T (*)[20002])c6_inData)[c6_i27 +
        c6_i25];
    }
  ...
  for (c6_i29 = 0; c6_i29 < 2; c6_i29++) {
    for (c6_i30 = 0; c6_i30 < 10001; c6_i30++) {
  ...
  if (!chartInstance->c6_uin_all_not_empty) {
    ...
    sf_mex_assign(&c6_y, sf_mex_create("y", c6_u, 0, 0U, 1U, 0U, 2, 10001, 2),
                  FALSE);
  }
   ...
   mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId, real_T c6_y[20002])
{
  ...
  if (mxIsEmpty(c6_u)) {
    ...
    sf_mex_import(c6_parentId, sf_mex_dup(c6_u), c6_dv5, 1, 0, 0U, 1, 0U, 2,
                  10001, 2);
    for (c6_i31 = 0; c6_i31 < 20002; c6_i31++) {
  ...
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData)
{
  ...
  for (c6_i33 = 0; c6_i33 < 2; c6_i33++) {
    for (c6_i34 = 0; c6_i34 < 10001; c6_i34++) {
      (*(real_T (*)[20002])c6_outData)[c6_i34 + c6_i32] = c6_y[c6_i34 + c6_i32];
    }
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2863130202U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3336036739U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(246862047U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(4149752890U);
}
...
mxArray *sf_c6_CoupledTanks_WCPS_v2_DoubleSD_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("dEtZReqee2nXPy0s6Eog6");
...
static void mdlSetWorkWidths_c6_CoupledTanks_WCPS_v2_DoubleSD(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(555252309U));
  ssSetChecksum1(S,(3336356377U));
  ssSetChecksum2(S,(558941454U));
  ssSetChecksum3(S,(203085333U));
