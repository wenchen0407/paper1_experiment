...
static void c3_c_emlrt_marshallIn
  (SFc3_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance, const
   mxArray *c3_b_yin_all, const char_T *c3_identifier, real_T c3_y[50005]);
static void c3_d_emlrt_marshallIn
  (SFc3_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance, const
   mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId, real_T c3_y[50005]);
...
static void c3_o_emlrt_marshallIn
  (SFc3_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance, const
   mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
   c3_struct_PTeI9GbRx6qEACH0ttXZ7C *c3_y);
...
static void c3_s_emlrt_marshallIn
  (SFc3_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance, const
   mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId, real_T c3_y[1005]);
  ...
  (SFc3_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance)
{
  ...
  c3_struct_PTeI9GbRx6qEACH0ttXZ7C c3_r0;
  ...
  (SFc3_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance)
{
  ...
  if (!chartInstance->c3_yin_all_not_empty) {
    ...
    sf_mex_assign(&c3_g_y, sf_mex_create("y", c3_g_u, 0, 0U, 1U, 0U, 2, 10001, 5),
                  FALSE);
  }
   ...
   mxArray *c3_st)
{
  ...
  c3_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 5)),
                        "yin_all", c3_dv2);
  for (c3_i10 = 0; c3_i10 < 50005; c3_i10++) {
  ...
  (SFc3_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance)
{
  ...
  int32_T c3_i16;
  real_T c3_ydelay[15];
  c3_struct_PTeI9GbRx6qEACH0ttXZ7C c3_b_structure;
  ...
  if (CV_EML_IF(0, 1, 0, !chartInstance->c3_yin_not_empty)) {
    ...
    for (c3_i19 = 0; c3_i19 < 50005; c3_i19++) {
  ...
  while (c3_b_kk < 5) {
    ...
    chartInstance->c3_yin_all[((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      "yin_all", (int32_T)chartInstance->c3_num, 1, 10001, 1, 0) + 10001 *
    ...
    if (CV_EML_IF(0, 1, 1, chartInstance->c3_delay_data
      ...
      chartInstance->c3_yin[(int32_T)c3_j - 1] = chartInstance->c3_yin_all
        [((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("yin_all", (int32_T)
           chartInstance->c3_num, 1, 10001, 1, 0) + 10001 * ((int32_T)c3_j - 1))
        - 1];
    } else {
      ...
      if (CV_EML_IF(0, 1, 2, chartInstance->c3_num > 1.0)) {
        ...
        chartInstance->c3_yin[(int32_T)c3_j - 1] = chartInstance->c3_yin_all
          [((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("yin_all", (int32_T)
             (chartInstance->c3_num - 1.0), 1, 10001, 1, 0) + 10001 * ((int32_T)
             c3_j - 1)) - 1];
        ...
        chartInstance->c3_yin_all[((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
          ...
          - 1.0), 1, 10001, 1, 0) + 10001 * ((int32_T)c3_j - 1)) - 1];
      }
    }
  ...
  *c3_inData)
{
  ...
  int32_T c3_i40;
  int32_T c3_i41;
  static real_T c3_b_inData[50005];
  int32_T c3_i42;
  int32_T c3_i43;
  int32_T c3_i44;
  static real_T c3_u[50005];
  const mxArray *c3_y = NULL;
  SFc3_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *chartInstance;
  chartInstance = (SFc3_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *)
    chartInstanceVoid;
  ...
  for (c3_i40 = 0; c3_i40 < 5; c3_i40++) {
    for (c3_i41 = 0; c3_i41 < 10001; c3_i41++) {
      c3_b_inData[c3_i41 + c3_i39] = (*(real_T (*)[50005])c3_inData)[c3_i41 +
        c3_i39];
    }
  ...
  for (c3_i43 = 0; c3_i43 < 5; c3_i43++) {
    for (c3_i44 = 0; c3_i44 < 10001; c3_i44++) {
  ...
  if (!chartInstance->c3_yin_all_not_empty) {
    ...
    sf_mex_assign(&c3_y, sf_mex_create("y", c3_u, 0, 0U, 1U, 0U, 2, 10001, 5),
                  FALSE);
  }
   ...
   mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId, real_T c3_y[50005])
{
  ...
  if (mxIsEmpty(c3_u)) {
    ...
    sf_mex_import(c3_parentId, sf_mex_dup(c3_u), c3_dv6, 1, 0, 0U, 1, 0U, 2,
                  10001, 5);
    for (c3_i45 = 0; c3_i45 < 50005; c3_i45++) {
  ...
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  ...
  for (c3_i47 = 0; c3_i47 < 5; c3_i47++) {
    for (c3_i48 = 0; c3_i48 < 10001; c3_i48++) {
      (*(real_T (*)[50005])c3_outData)[c3_i48 + c3_i46] = c3_y[c3_i48 + c3_i46];
    }
...
{
  const mxArray *c3_mxArrayOutData = NULL;
  c3_struct_PTeI9GbRx6qEACH0ttXZ7C c3_u;
  const mxArray *c3_y = NULL;
  real_T c3_b_u;
  const mxArray *c3_b_y = NULL;
  real_T c3_c_u;
  ...
  chartInstance = (SFc3_CoupledTanks_WCPS_v2_DoubleSDInstanceStruct *)
    chartInstanceVoid;
  c3_mxArrayOutData = NULL;
  c3_u = *(c3_struct_PTeI9GbRx6qEACH0ttXZ7C *)c3_inData;
  c3_y = NULL;
  ...
  for (c3_i69 = 0; c3_i69 < 1005; c3_i69++) {
    c3_f_u[c3_i69] = c3_u.delay1[c3_i69];
  }

  c3_f_y = NULL;
  sf_mex_assign(&c3_f_y, sf_mex_create("y", c3_f_u, 0, 0U, 1U, 0U, 2, 201, 5),
                FALSE);
   ...
   mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId, real_T c3_y[1005])
{
  real_T c3_dv12[1005];
  int32_T c3_i73;
  sf_mex_import(c3_parentId, sf_mex_dup(c3_u), c3_dv12, 1, 0, 0U, 1, 0U, 2, 201,
                5);
  for (c3_i73 = 0; c3_i73 < 1005; c3_i73++) {
  ...
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  ...
  *(c3_struct_PTeI9GbRx6qEACH0ttXZ7C *)c3_outData = c3_y;
  sf_mex_destroy(&c3_mxArrayInData);
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3790165370U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1021905169U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2382582949U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(356098865U);
}
...
mxArray *sf_c3_CoupledTanks_WCPS_v2_DoubleSD_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("Bxjmkz7A14cx1P7G16ff9D");
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1421);
...
static void mdlSetWorkWidths_c3_CoupledTanks_WCPS_v2_DoubleSD(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3729459229U));
  ssSetChecksum1(S,(3256459984U));
  ssSetChecksum2(S,(3645182740U));
  ssSetChecksum3(S,(1691264766U));
