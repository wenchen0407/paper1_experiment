...
static const char *c1_debug_family_names[10] = { "result", "status", "delay",
  "nargin", "nargout", "ymea", "ymea1", "ydelay", "delay1", "i" };

/* Function Declarations */
static void initialize_c1_SIMUL_step_delay_Embed_integrated_v3
  (SFc1_SIMUL_step_delay_Embed_integrated_v3InstanceStruct *chartInstance);
static void initialize_params_c1_SIMUL_step_delay_Embed_integrated_v3
  (SFc1_SIMUL_step_delay_Embed_integrated_v3InstanceStruct *chartInstance);
static void enable_c1_SIMUL_step_delay_Embed_integrated_v3
  (SFc1_SIMUL_step_delay_Embed_integrated_v3InstanceStruct *chartInstance);
static void disable_c1_SIMUL_step_delay_Embed_integrated_v3
  (SFc1_SIMUL_step_delay_Embed_integrated_v3InstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_SIMUL_step_delay_Embed_integrated_v
  (SFc1_SIMUL_step_delay_Embed_integrated_v3InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_SIMUL_step_delay_Embed_integrated_v3
  (SFc1_SIMUL_step_delay_Embed_integrated_v3InstanceStruct *chartInstance);
static void set_sim_state_c1_SIMUL_step_delay_Embed_integrated_v3
  (SFc1_SIMUL_step_delay_Embed_integrated_v3InstanceStruct *chartInstance, const
   mxArray *c1_st);
static void finalize_c1_SIMUL_step_delay_Embed_integrated_v3
  (SFc1_SIMUL_step_delay_Embed_integrated_v3InstanceStruct *chartInstance);
static void sf_c1_SIMUL_step_delay_Embed_integrated_v3
  (SFc1_SIMUL_step_delay_Embed_integrated_v3InstanceStruct *chartInstance);
static void c1_c1_SIMUL_step_delay_Embed_integrated_v3
  (SFc1_SIMUL_step_delay_Embed_integrated_v3InstanceStruct *chartInstance);
static void
  compInitSubchartSimstructsFcn_c1_SIMUL_step_delay_Embed_integrated_v3
  (SFc1_SIMUL_step_delay_Embed_integrated_v3InstanceStruct *chartInstance);
...
static uint8_T c1_f_emlrt_marshallIn
  (SFc1_SIMUL_step_delay_Embed_integrated_v3InstanceStruct *chartInstance, const
   mxArray *c1_b_is_active_c1_SIMUL_step_delay_Embed_integrated_v3, const char_T
   *c1_name);
...
static void initialize_c1_SIMUL_step_delay_Embed_integrated_v3
  (SFc1_SIMUL_step_delay_Embed_integrated_v3InstanceStruct *
   chartInstance)
{
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  chartInstance->c1_delay1_not_empty = FALSE;
  chartInstance->c1_i_not_empty = FALSE;
  chartInstance->c1_is_active_c1_SIMUL_step_delay_Embed_integrated_v3 = 0U;
}
   ...
   *chartInstance)
{
  ...
  c1_e_hoistedGlobal =
    chartInstance->c1_is_active_c1_SIMUL_step_delay_Embed_integrated_v3;
   ...
   chartInstance, const mxArray *c1_st)
{
  ...
  chartInstance->c1_is_active_c1_SIMUL_step_delay_Embed_integrated_v3 =
    c1_f_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
                           (c1_u, 4)),
    "is_active_c1_SIMUL_step_delay_Embed_integrated_v3");
  sf_mex_destroy(&c1_u);
  ...
  (SFc1_SIMUL_step_delay_Embed_integrated_v3InstanceStruct *chartInstance)
{
  ...
  for (c1_i9 = 0; c1_i9 < 4; c1_i9 = c1_i9 + 1) {
    _SFD_DATA_RANGE_CHECK((*c1_ymea1)[c1_i9], 0U);
  }

  for (c1_i10 = 0; c1_i10 < 4; c1_i10 = c1_i10 + 1) {
    _SFD_DATA_RANGE_CHECK((*c1_ymea)[c1_i10], 1U);
  }

  for (c1_i11 = 0; c1_i11 < 5; c1_i11 = c1_i11 + 1) {
    _SFD_DATA_RANGE_CHECK((*c1_ydelay)[c1_i11], 2U);
  }

  c1_previousEvent = _sfEvent_;
  _sfEvent_ = CALL_EVENT;
  c1_c1_SIMUL_step_delay_Embed_integrated_v3(chartInstance);
  ...
  (SFc1_SIMUL_step_delay_Embed_integrated_v3InstanceStruct *chartInstance)
{
  ...
  static const char *c1_sv0[10] = { "result", "status", "delay", "nargin",
    "nargout", "ymea", "ymea1", "ydelay", "delay1", "i" };
  ...
  sf_debug_symbol_scope_add_eml(chartInstance->c1_delay1, c1_b_sf_marshall, 8U);
  sf_debug_symbol_scope_add_eml(&chartInstance->c1_i, c1_sf_marshall, 9U);
  CV_EML_FCN(0, 0);
  ...
  if (CV_EML_IF(0, 0, !chartInstance->c1_i_not_empty)) {
    ...
    c1_xk = c1_x;
    c1_b_x = c1_xk;
    c1_r = muDoubleScalarRem(c1_b_x, 10.0);
...
static const mxArray *c1_sf_marshall(void *chartInstanceVoid, void *c1_u)
{
  ...
  const mxArray *c1_b_y = NULL;
  SFc1_SIMUL_step_delay_Embed_integrated_v3InstanceStruct *chartInstance;
  chartInstance = (SFc1_SIMUL_step_delay_Embed_integrated_v3InstanceStruct *)
    chartInstanceVoid;
  c1_y = NULL;
  c1_b_u = *((real_T *)c1_u);
  c1_b_y = NULL;
...
static const mxArray *c1_c_sf_marshall(void *chartInstanceVoid, void *c1_u)
{
  ...
  chartInstance = (SFc1_SIMUL_step_delay_Embed_integrated_v3InstanceStruct *)
    chartInstanceVoid;
  c1_y = NULL;
  for (c1_i31 = 0; c1_i31 < 5; c1_i31 = c1_i31 + 1) {
    c1_b_u[c1_i31] = (*((real_T (*)[5])c1_u))[c1_i31];
  }

  for (c1_i32 = 0; c1_i32 < 5; c1_i32 = c1_i32 + 1) {
    c1_c_u[c1_i32] = c1_b_u[c1_i32];
  }
...
static const mxArray *c1_d_sf_marshall(void *chartInstanceVoid, void *c1_u)
{
  ...
  chartInstance = (SFc1_SIMUL_step_delay_Embed_integrated_v3InstanceStruct *)
    chartInstanceVoid;
  c1_y = NULL;
  for (c1_i33 = 0; c1_i33 < 4; c1_i33 = c1_i33 + 1) {
    c1_b_u[c1_i33] = (*((real_T (*)[4])c1_u))[c1_i33];
  }

  for (c1_i34 = 0; c1_i34 < 4; c1_i34 = c1_i34 + 1) {
    c1_c_u[c1_i34] = c1_b_u[c1_i34];
  }
  ...
  (void)
{
  ...
  for (c1_i35 = 0; c1_i35 < 19; c1_i35 = c1_i35 + 1) {
    ...
    sf_mex_addfield(c1_m4, sf_mex_create("nameCaptureInfo", c1_r0->dominantType,
      15, 0U, 0U, 0U, 2, 1, strlen(c1_r0->dominantType)),
                    "dominantType", "nameCaptureInfo", c1_i35);
    ...
    sf_mex_addfield(c1_m4, sf_mex_create("nameCaptureInfo", &c1_r0->fileTime1, 7,
      0U, 0U, 0U, 0), "fileTime1", "nameCaptureInfo", c1_i35
                    );
    sf_mex_addfield(c1_m4, sf_mex_create("nameCaptureInfo", &c1_r0->fileTime2, 7,
      0U, 0U, 0U, 0), "fileTime2", "nameCaptureInfo", c1_i35
                    );
  }
...
static void c1_info_helper(c1_ResolvedFunctionInfo c1_info[19])
{
  ...
  c1_info[1].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/rem.m";
  c1_info[1].fileLength = 961U;
  c1_info[1].fileTime1 = 1245127576U;
  c1_info[1].fileTime2 = 0U;
  c1_info[2].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/rem.m";
  ...
  c1_info[3].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/rem.m";
  c1_info[3].name = "gt";
  ...
  c1_info[4].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/rem.m";
  ...
  c1_info[5].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/rem.m";
  c1_info[5].name = "isa";
  ...
  c1_info[6].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/rem.m";
  ...
  c1_info[7].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/rem.m";
  ...
  c1_info[13].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/rem.m";
  c1_info[13].name = "eml_scalexp_alloc";
  c1_info[13].dominantType = "double";
  c1_info[13].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalexp_alloc.m";
  c1_info[13].fileLength = 932U;
  c1_info[13].fileTime1 = 1261977070U;
  ...
  c1_info[17].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/rem.m";
  ...
  c1_info[17].fileLength = 1166U;
  c1_info[17].fileTime1 = 1261977068U;
   ...
   const char_T *c1_name, real_T c1_y[5])
{
  ...
  for (c1_i36 = 0; c1_i36 < 5; c1_i36 = c1_i36 + 1) {
    c1_y[c1_i36] = c1_dv6[c1_i36];
  }
   ...
   , const char_T *c1_name, real_T c1_y[5])
{
  ...
  if (mxIsEmpty(c1_b_delay1)) {
    ...
    sf_mex_import(c1_name, sf_mex_dup(c1_b_delay1), c1_dv8, 1, 0, 0U, 1, 0U, 1,
                  5);
    for (c1_i38 = 0; c1_i38 < 5; c1_i38 = c1_i38 + 1) {
...
static uint8_T c1_f_emlrt_marshallIn
  (SFc1_SIMUL_step_delay_Embed_integrated_v3InstanceStruct *chartInstance, const
   mxArray *
   c1_b_is_active_c1_SIMUL_step_delay_Embed_integrated_v3, const char_T *c1_name)
{
  uint8_T c1_y;
  uint8_T c1_u0;
  sf_mex_import(c1_name, sf_mex_dup
                (c1_b_is_active_c1_SIMUL_step_delay_Embed_integrated_v3), &c1_u0,
                1, 3, 0U, 0, 0U, 0);
  c1_y = c1_u0;
  sf_mex_destroy(&c1_b_is_active_c1_SIMUL_step_delay_Embed_integrated_v3);
  return c1_y;
}
...
/* SFunction Glue Code */
void sf_c1_SIMUL_step_delay_Embed_integrated_v3_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2100493203U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2595916474U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3195921703U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3110566287U);
}

mxArray *sf_c1_SIMUL_step_delay_Embed_integrated_v3_get_autoinheritance_info
  (void)
{
...

  {
    ...
    pr[0] = (double)(3967037264U);
    pr[1] = (double)(3616774478U);
    pr[2] = (double)(2338404235U);
    pr[3] = (double)(1547635665U);
...
static mxArray *sf_get_sim_state_info_c1_SIMUL_step_delay_Embed_integrated_v3
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[5],T\"ydelay\",},{M[1],M[7],T\"ymea1\",},{M[4],M[0],T\"delay1\",S'l','i','p'{{M1x2[168 174],M[0],}}},{M[4],M[0],T\"i\",S'l','i','p'{{M1x2[200 201],M[0],}}},{M[8],M[0],T\"is_active_c1_SIMUL_step_delay_Embed_integrated_v3\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_SIMUL_step_delay_Embed_integrated_v3_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c1_SIMUL_step_delay_Embed_integrated_v3(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc1_SIMUL_step_delay_Embed_integrated_v3InstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c1_SIMUL_step_delay_Embed_integrated_v3
    ((SFc1_SIMUL_step_delay_Embed_integrated_v3InstanceStruct*) chartInstanceVar);
  initialize_c1_SIMUL_step_delay_Embed_integrated_v3
    ((SFc1_SIMUL_step_delay_Embed_integrated_v3InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_SIMUL_step_delay_Embed_integrated_v3(void
  *chartInstanceVar)
{
  enable_c1_SIMUL_step_delay_Embed_integrated_v3
    ((SFc1_SIMUL_step_delay_Embed_integrated_v3InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_SIMUL_step_delay_Embed_integrated_v3(void
  *chartInstanceVar)
{
  disable_c1_SIMUL_step_delay_Embed_integrated_v3
    ((SFc1_SIMUL_step_delay_Embed_integrated_v3InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_SIMUL_step_delay_Embed_integrated_v3(void
  *chartInstanceVar)
{
  sf_c1_SIMUL_step_delay_Embed_integrated_v3
    ((SFc1_SIMUL_step_delay_Embed_integrated_v3InstanceStruct*) chartInstanceVar);
}

static mxArray*
  sf_internal_get_sim_state_c1_SIMUL_step_delay_Embed_integrated_v3(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_SIMUL_step_delay_Embed_integrated_v3
    ((SFc1_SIMUL_step_delay_Embed_integrated_v3InstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = sf_get_sim_state_info_c1_SIMUL_step_delay_Embed_integrated_v3();/* state var info */
...
static void sf_internal_set_sim_state_c1_SIMUL_step_delay_Embed_integrated_v3
  (SimStruct* S, const mxArray *st)
{
  ...
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c1_SIMUL_step_delay_Embed_integrated_v3();/* state var info */
  mxError = sf_mex_call_matlab(1, plhs, 4, prhs, "sfprivate");
  mxDestroyArray(prhs[0]);
  mxDestroyArray(prhs[1]);
  mxDestroyArray(prhs[2]);
  ...
  set_sim_state_c1_SIMUL_step_delay_Embed_integrated_v3
    ((SFc1_SIMUL_step_delay_Embed_integrated_v3InstanceStruct*)
     chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static mxArray* sf_opaque_get_sim_state_c1_SIMUL_step_delay_Embed_integrated_v3
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c1_SIMUL_step_delay_Embed_integrated_v3(S);
}

static void sf_opaque_set_sim_state_c1_SIMUL_step_delay_Embed_integrated_v3
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c1_SIMUL_step_delay_Embed_integrated_v3(S, st);
}

static void sf_opaque_terminate_c1_SIMUL_step_delay_Embed_integrated_v3(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_SIMUL_step_delay_Embed_integrated_v3InstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c1_SIMUL_step_delay_Embed_integrated_v3
      ((SFc1_SIMUL_step_delay_Embed_integrated_v3InstanceStruct*)
       chartInstanceVar);
...
static void mdlProcessParameters_c1_SIMUL_step_delay_Embed_integrated_v3
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_SIMUL_step_delay_Embed_integrated_v3(SimStruct
  *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"SIMUL_step_delay_Embed_integrated_v3",
      "SIMUL_step_delay_Embed_integrated_v3",1);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"SIMUL_step_delay_Embed_integrated_v3",
                "SIMUL_step_delay_Embed_integrated_v3",1,"RTWCG"));
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,
        "SIMUL_step_delay_Embed_integrated_v3",
        "SIMUL_step_delay_Embed_integrated_v3",1,1);
      sf_mark_chart_reusable_outputs(S,"SIMUL_step_delay_Embed_integrated_v3",
        "SIMUL_step_delay_Embed_integrated_v3",1,2);
    }
  ...
  ssSetChecksum0(S,(3174577751U));
  ssSetChecksum1(S,(3418975886U));
  ssSetChecksum2(S,(1908944459U));
  ssSetChecksum3(S,(3009332947U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c1_SIMUL_step_delay_Embed_integrated_v3(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_SIMUL_step_delay_Embed_integrated_v3(SimStruct *S)
{
  SFc1_SIMUL_step_delay_Embed_integrated_v3InstanceStruct *chartInstance;
  chartInstance = (SFc1_SIMUL_step_delay_Embed_integrated_v3InstanceStruct *)
    malloc(sizeof(SFc1_SIMUL_step_delay_Embed_integrated_v3InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_SIMUL_step_delay_Embed_integrated_v3;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_SIMUL_step_delay_Embed_integrated_v3;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_SIMUL_step_delay_Embed_integrated_v3;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c1_SIMUL_step_delay_Embed_integrated_v3;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c1_SIMUL_step_delay_Embed_integrated_v3;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_SIMUL_step_delay_Embed_integrated_v3;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_SIMUL_step_delay_Embed_integrated_v3;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_SIMUL_step_delay_Embed_integrated_v3;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c1_SIMUL_step_delay_Embed_integrated_v3;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c1_SIMUL_step_delay_Embed_integrated_v3;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_SIMUL_step_delay_Embed_integrated_v3;
...
void c1_SIMUL_step_delay_Embed_integrated_v3_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_SIMUL_step_delay_Embed_integrated_v3(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_SIMUL_step_delay_Embed_integrated_v3(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_SIMUL_step_delay_Embed_integrated_v3(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_SIMUL_step_delay_Embed_integrated_v3_method_dispatcher.\n"
