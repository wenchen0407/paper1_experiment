...
#include "c4_CoupledTanks_doubletank_bo.h"
...
static void initialize_c4_CoupledTanks_doubletank_bo
  (SFc4_CoupledTanks_doubletank_boInstanceStruct *chartInstance);
static void initialize_params_c4_CoupledTanks_doubletank_bo
  (SFc4_CoupledTanks_doubletank_boInstanceStruct *chartInstance);
static void enable_c4_CoupledTanks_doubletank_bo
  (SFc4_CoupledTanks_doubletank_boInstanceStruct *chartInstance);
static void disable_c4_CoupledTanks_doubletank_bo
  (SFc4_CoupledTanks_doubletank_boInstanceStruct *chartInstance);
static void c4_update_debugger_state_c4_CoupledTanks_doubletank_bo
  (SFc4_CoupledTanks_doubletank_boInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c4_CoupledTanks_doubletank_bo
  (SFc4_CoupledTanks_doubletank_boInstanceStruct *chartInstance);
static void set_sim_state_c4_CoupledTanks_doubletank_bo
  (SFc4_CoupledTanks_doubletank_boInstanceStruct *chartInstance, const mxArray
   *c4_st);
static void finalize_c4_CoupledTanks_doubletank_bo
  (SFc4_CoupledTanks_doubletank_boInstanceStruct *chartInstance);
static void sf_c4_CoupledTanks_doubletank_bo
  (SFc4_CoupledTanks_doubletank_boInstanceStruct *chartInstance);
static void initSimStructsc4_CoupledTanks_doubletank_bo
  (SFc4_CoupledTanks_doubletank_boInstanceStruct *chartInstance);
static void registerMessagesc4_CoupledTanks_doubletank_bo
  (SFc4_CoupledTanks_doubletank_boInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c4_machineNumber, uint32_T
  c4_chartNumber);
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData);
static real_T c4_emlrt_marshallIn(SFc4_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance, const mxArray *c4_b_numAct, const char_T *c4_identifier);
...
static const mxArray *c4_b_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static void c4_c_emlrt_marshallIn(SFc4_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance, const mxArray *c4_b_uin_all, const char_T *c4_identifier,
  real_T c4_y[1600002]);
static void c4_d_emlrt_marshallIn(SFc4_CoupledTanks_doubletank_boInstanceStruct *
...
static const mxArray *c4_c_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static void c4_e_emlrt_marshallIn(SFc4_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance, const mxArray *c4_b_delay, const char_T *c4_identifier, real_T
  c4_y[15]);
static void c4_f_emlrt_marshallIn(SFc4_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId,
  real_T c4_y[15]);
...
static const mxArray *c4_d_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static void c4_g_emlrt_marshallIn(SFc4_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance, const mxArray *c4_b_uin, const char_T *c4_identifier, real_T
  c4_y[2]);
static void c4_h_emlrt_marshallIn(SFc4_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId,
  real_T c4_y[2]);
...
static const mxArray *c4_e_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static void c4_i_emlrt_marshallIn(SFc4_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance, const mxArray *c4_b_uin_d, const char_T *c4_identifier, real_T
  c4_y[2]);
static void c4_j_emlrt_marshallIn(SFc4_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId,
  real_T c4_y[2]);
...
static const mxArray *c4_f_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static void c4_k_emlrt_marshallIn(SFc4_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance, const mxArray *c4_uout_delay, const char_T *c4_identifier,
  real_T c4_y[2]);
static void c4_l_emlrt_marshallIn(SFc4_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId,
  real_T c4_y[2]);
...
static uint8_T c4_o_emlrt_marshallIn
  (SFc4_CoupledTanks_doubletank_boInstanceStruct *chartInstance, const mxArray
   *c4_b_is_active_c4_CoupledTanks_doubletank_bo, const char_T *c4_identifier);
static uint8_T c4_p_emlrt_marshallIn
  (SFc4_CoupledTanks_doubletank_boInstanceStruct *chartInstance, const mxArray
   *c4_u, const emlrtMsgIdentifier *c4_parentId);
static int32_T c4_get_counter_global
  (SFc4_CoupledTanks_doubletank_boInstanceStruct *chartInstance, uint32_T c4_b);
static void c4_set_counter_global(SFc4_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance, uint32_T c4_b, int32_T c4_c);
static int32_T *c4_access_counter_global
  (SFc4_CoupledTanks_doubletank_boInstanceStruct *chartInstance, uint32_T c4_b);
static void init_dsm_address_info(SFc4_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance);
  ...
  (SFc4_CoupledTanks_doubletank_boInstanceStruct *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_CoupledTanks_doubletank_bo = 0U;
}
  ...
  (SFc4_CoupledTanks_doubletank_boInstanceStruct *chartInstance)
{
  ...
  for (c4_i3 = 0; c4_i3 < 1600002; c4_i3++) {
  ...
  if (!chartInstance->c4_uin_all_not_empty) {
    ...
    sf_mex_assign(&c4_f_y, sf_mex_create("y", c4_e_u, 0, 0U, 1U, 0U, 2, 800001,
      2), FALSE);
  }
  ...
  c4_b_hoistedGlobal = chartInstance->c4_is_active_c4_CoupledTanks_doubletank_bo;
   ...
   *c4_st)
{
  ...
  c4_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 4)),
                        "uin_all", c4_dv3);
  for (c4_i8 = 0; c4_i8 < 1600002; c4_i8++) {
  ...
  chartInstance->c4_is_active_c4_CoupledTanks_doubletank_bo =
    c4_o_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 6)),
    "is_active_c4_CoupledTanks_doubletank_bo");
  sf_mex_destroy(&c4_u);
  c4_update_debugger_state_c4_CoupledTanks_doubletank_bo(chartInstance);
  ...
  (SFc4_CoupledTanks_doubletank_boInstanceStruct *chartInstance)
{
  ...
  int32_T c4_b_j;
  int32_T c4_i22;
  static char_T c4_cv0[43] = { 'd', 'a', 't', 'a', ' ', 'b', 'l', 'o', 'c', 'k',
    ' ', '2', ',', ' ', 'p', 'l', 'a', 'n', 't', ' ', '1', ',', ' ', 'p', 'a',
    'c', 'k', 'e', 't', ' ', 'w', 'a', 's', ' ', 'r', 'e', 'c', 'e', 'i', 'v',
    'e', 'd', '.' };
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML(&c4_actnum, 0U, c4_h_sf_marshallOut);
  ...
  if (CV_EML_IF(0, 1, 0, !chartInstance->c4_uin_not_empty)) {
    ...
    for (c4_i17 = 0; c4_i17 < 1600002; c4_i17++) {
  ...
  while (c4_b_kk < 2) {
    ...
    chartInstance->c4_uin_all[((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
      ...
      1, 800001, 1, 0) + 800001 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
  ...
  while (c4_b_j < 2) {
          ...
          _SFD_INTEGER_CHECK("j + 11", c4_j + 11.0), 1, 15, 2, 0) - 1] != 88.0))
    {
      ...
      chartInstance->c4_uin[(int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("uin",
        ...
        chartInstance->c4_numAct), 1, 800001, 1, 0) + 800001 * ((int32_T)(real_T)
        _SFD_EML_ARRAY_BOUNDS_CHECK("uin_all", (int32_T)_SFD_INTEGER_CHECK("j",
        c4_j), 1, 2, 2, 0) - 1)) - 1];
      _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 46);
      for (c4_i22 = 0; c4_i22 < 43; c4_i22++) {
        c4_u[c4_i22] = c4_cv0[c4_i22];
      }

      c4_y = NULL;
      sf_mex_assign(&c4_y, sf_mex_create("y", c4_u, 10, 0U, 1U, 0U, 2, 1, 43),
                    FALSE);
      ...
      if (CV_EML_IF(0, 1, 2, chartInstance->c4_numAct > 1.0)) {
        ...
        chartInstance->c4_uin[(int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("uin",
          ...
          "numAct - 1", chartInstance->c4_numAct - 1.0), 1, 800001, 1, 0) +
          800001 * ((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("uin_all",
          (int32_T)_SFD_INTEGER_CHECK("j", c4_j), 1, 2, 2, 0) - 1)) - 1];
        _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 51);
        chartInstance->c4_uin_all[((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
          "uin_all", (int32_T)_SFD_INTEGER_CHECK("numAct",
          chartInstance->c4_numAct), 1, 800001, 1, 0) + 800001 * ((int32_T)
  ...
  for (c4_i23 = 0; c4_i23 < 2; c4_i23++) {
    chartInstance->c4_uin_d[c4_i23] = chartInstance->c4_uin[c4_i23];
  }

  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 57);
  for (c4_i24 = 0; c4_i24 < 2; c4_i24++) {
    c4_uout_delay[c4_i24] = chartInstance->c4_uin_d[c4_i24];
  }
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  const mxArray *c4_y = NULL;
  SFc4_CoupledTanks_doubletank_boInstanceStruct *chartInstance;
  chartInstance = (SFc4_CoupledTanks_doubletank_boInstanceStruct *)
    chartInstanceVoid;
  ...
  *c4_inData)
{
  ...
  int32_T c4_i27;
  int32_T c4_i28;
  static real_T c4_b_inData[1600002];
  int32_T c4_i29;
  int32_T c4_i30;
  int32_T c4_i31;
  static real_T c4_u[1600002];
  const mxArray *c4_y = NULL;
  SFc4_CoupledTanks_doubletank_boInstanceStruct *chartInstance;
  chartInstance = (SFc4_CoupledTanks_doubletank_boInstanceStruct *)
    chartInstanceVoid;
  ...
  for (c4_i27 = 0; c4_i27 < 2; c4_i27++) {
    for (c4_i28 = 0; c4_i28 < 800001; c4_i28++) {
      c4_b_inData[c4_i28 + c4_i26] = (*(real_T (*)[1600002])c4_inData)[c4_i28 +
        c4_i26];
    }
  ...
  for (c4_i30 = 0; c4_i30 < 2; c4_i30++) {
    for (c4_i31 = 0; c4_i31 < 800001; c4_i31++) {
  ...
  if (!chartInstance->c4_uin_all_not_empty) {
    ...
    sf_mex_assign(&c4_y, sf_mex_create("y", c4_u, 0, 0U, 1U, 0U, 2, 800001, 2),
                  FALSE);
  }
  ...
  real_T c4_y[1600002])
{
  ...
  if (mxIsEmpty(c4_u)) {
    ...
    sf_mex_import(c4_parentId, sf_mex_dup(c4_u), c4_dv5, 1, 0, 0U, 1, 0U, 2,
                  800001, 2);
    for (c4_i32 = 0; c4_i32 < 1600002; c4_i32++) {
  ...
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData)
{
  ...
  for (c4_i34 = 0; c4_i34 < 2; c4_i34++) {
    for (c4_i35 = 0; c4_i35 < 800001; c4_i35++) {
      (*(real_T (*)[1600002])c4_outData)[c4_i35 + c4_i33] = c4_y[c4_i35 + c4_i33];
    }
...
const mxArray *sf_c4_CoupledTanks_doubletank_bo_get_eml_resolved_functions_info
  (void)
{
   ...
   *c4_b_is_active_c4_CoupledTanks_doubletank_bo, const char_T *c4_identifier)
{
  ...
  c4_y = c4_p_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_CoupledTanks_doubletank_bo), &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_CoupledTanks_doubletank_bo);
  return c4_y;
}
  ...
  (SFc4_CoupledTanks_doubletank_boInstanceStruct *chartInstance, uint32_T c4_b)
{
  ...
  if (chartInstance->c4_counter_global_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'counter_global\' (#56) in the initialization routine of the chart.\n");
  }
...
void sf_c4_CoupledTanks_doubletank_bo_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2638873214U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1619557187U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(884083747U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(764441581U);
}

mxArray *sf_c4_CoupledTanks_doubletank_bo_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("VfCLpqVRYRBbzIgZsCQKBH");
...
mxArray *sf_c4_CoupledTanks_doubletank_bo_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c4_CoupledTanks_doubletank_bo(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x7'type','srcId','name','auxInfo'{{M[1],M[5],T\"uout_delay\",},{M[4],M[0],T\"delay\",S'l','i','p'{{M1x2[260 265],M[0],}}},{M[4],M[0],T\"numAct\",S'l','i','p'{{M1x2[274 280],M[0],}}},{M[4],M[0],T\"uin\",S'l','i','p'{{M1x2[256 259],M[0],}}},{M[4],M[0],T\"uin_all\",S'l','i','p'{{M1x2[266 273],M[0],}}},{M[4],M[0],T\"uin_d\",S'l','i','p'{{M1x2[238 243],M[0],}}},{M[8],M[0],T\"is_active_c4_CoupledTanks_doubletank_bo\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 7, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_CoupledTanks_doubletank_bo_get_check_sum(&mxChecksum);
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(3,11,0,0,"counter_global");
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1504);
        _SFD_CV_INIT_EML_IF(0,1,0,422,437,-1,669);
        _SFD_CV_INIT_EML_IF(0,1,1,909,932,1051,1291);
        _SFD_CV_INIT_EML_IF(0,1,2,1064,1077,-1,1275);
        _SFD_CV_INIT_EML_FOR(0,1,0,785,803,842);
        _SFD_CV_INIT_EML_FOR(0,1,1,890,905,1295);
        ...
        _SFD_SET_DATA_COMPILED_PROPS(3,SF_INT32,0,NULL,0,0,0,0.0,1.0,0,0,
          (MexFcnForType)c4_i_sf_marshallOut,(MexInFcnForType)c4_h_sf_marshallIn);

        {
          ...
          _SFD_SET_DATA_VALUE_PTR(3U, chartInstance->c4_counter_global_address);
        }
      }
    } else {
...
{
  return "VScSPQRfXbg3PdkQGXXGnH";
}

static void sf_opaque_initialize_c4_CoupledTanks_doubletank_bo(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc4_CoupledTanks_doubletank_boInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c4_CoupledTanks_doubletank_bo
    ((SFc4_CoupledTanks_doubletank_boInstanceStruct*) chartInstanceVar);
  initialize_c4_CoupledTanks_doubletank_bo
    ((SFc4_CoupledTanks_doubletank_boInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c4_CoupledTanks_doubletank_bo(void
  *chartInstanceVar)
{
  enable_c4_CoupledTanks_doubletank_bo
    ((SFc4_CoupledTanks_doubletank_boInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c4_CoupledTanks_doubletank_bo(void
  *chartInstanceVar)
{
  disable_c4_CoupledTanks_doubletank_bo
    ((SFc4_CoupledTanks_doubletank_boInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c4_CoupledTanks_doubletank_bo(void
  *chartInstanceVar)
{
  sf_c4_CoupledTanks_doubletank_bo
    ((SFc4_CoupledTanks_doubletank_boInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c4_CoupledTanks_doubletank_bo
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c4_CoupledTanks_doubletank_bo
    ((SFc4_CoupledTanks_doubletank_boInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c4_CoupledTanks_doubletank_bo();/* state var info */
...
extern void sf_internal_set_sim_state_c4_CoupledTanks_doubletank_bo(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c4_CoupledTanks_doubletank_bo
    ((SFc4_CoupledTanks_doubletank_boInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c4_CoupledTanks_doubletank_bo
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c4_CoupledTanks_doubletank_bo(S);
}

static void sf_opaque_set_sim_state_c4_CoupledTanks_doubletank_bo(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c4_CoupledTanks_doubletank_bo(S, st);
}

static void sf_opaque_terminate_c4_CoupledTanks_doubletank_bo(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_CoupledTanks_doubletank_boInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c4_CoupledTanks_doubletank_bo
      ((SFc4_CoupledTanks_doubletank_boInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc4_CoupledTanks_doubletank_bo
    ((SFc4_CoupledTanks_doubletank_boInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_CoupledTanks_doubletank_bo(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c4_CoupledTanks_doubletank_bo
      ((SFc4_CoupledTanks_doubletank_boInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c4_CoupledTanks_doubletank_bo(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(1968892991U));
  ssSetChecksum1(S,(1806665811U));
  ssSetChecksum2(S,(3171439290U));
  ssSetChecksum3(S,(443724822U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,0);
}

static void mdlRTW_c4_CoupledTanks_doubletank_bo(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_CoupledTanks_doubletank_bo(SimStruct *S)
{
  SFc4_CoupledTanks_doubletank_boInstanceStruct *chartInstance;
  chartInstance = (SFc4_CoupledTanks_doubletank_boInstanceStruct *)utMalloc
    (sizeof(SFc4_CoupledTanks_doubletank_boInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc4_CoupledTanks_doubletank_boInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c4_CoupledTanks_doubletank_bo;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c4_CoupledTanks_doubletank_bo;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c4_CoupledTanks_doubletank_bo;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c4_CoupledTanks_doubletank_bo;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c4_CoupledTanks_doubletank_bo;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c4_CoupledTanks_doubletank_bo;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c4_CoupledTanks_doubletank_bo;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c4_CoupledTanks_doubletank_bo;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_CoupledTanks_doubletank_bo;
  chartInstance->chartInfo.mdlStart = mdlStart_c4_CoupledTanks_doubletank_bo;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c4_CoupledTanks_doubletank_bo;
...
void c4_CoupledTanks_doubletank_bo_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_CoupledTanks_doubletank_bo(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_CoupledTanks_doubletank_bo(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_CoupledTanks_doubletank_bo(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_CoupledTanks_doubletank_bo_method_dispatcher.\n"
