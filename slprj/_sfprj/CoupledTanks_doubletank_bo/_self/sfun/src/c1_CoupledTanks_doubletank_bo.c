...
#include <stddef.h>
#include "blas.h"
#include "CoupledTanks_doubletank_bo_sfun.h"
#include "c1_CoupledTanks_doubletank_bo.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "CoupledTanks_doubletank_bo_sfun_debug_macros.h"
...
static void initialize_c1_CoupledTanks_doubletank_bo
  (SFc1_CoupledTanks_doubletank_boInstanceStruct *chartInstance);
static void initialize_params_c1_CoupledTanks_doubletank_bo
  (SFc1_CoupledTanks_doubletank_boInstanceStruct *chartInstance);
static void enable_c1_CoupledTanks_doubletank_bo
  (SFc1_CoupledTanks_doubletank_boInstanceStruct *chartInstance);
static void disable_c1_CoupledTanks_doubletank_bo
  (SFc1_CoupledTanks_doubletank_boInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_CoupledTanks_doubletank_bo
  (SFc1_CoupledTanks_doubletank_boInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_CoupledTanks_doubletank_bo
  (SFc1_CoupledTanks_doubletank_boInstanceStruct *chartInstance);
static void set_sim_state_c1_CoupledTanks_doubletank_bo
  (SFc1_CoupledTanks_doubletank_boInstanceStruct *chartInstance, const mxArray
   *c1_st);
static void finalize_c1_CoupledTanks_doubletank_bo
  (SFc1_CoupledTanks_doubletank_boInstanceStruct *chartInstance);
static void sf_c1_CoupledTanks_doubletank_bo
  (SFc1_CoupledTanks_doubletank_boInstanceStruct *chartInstance);
static void initSimStructsc1_CoupledTanks_doubletank_bo
  (SFc1_CoupledTanks_doubletank_boInstanceStruct *chartInstance);
static void registerMessagesc1_CoupledTanks_doubletank_bo
  (SFc1_CoupledTanks_doubletank_boInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static int32_T c1_emlrt_marshallIn(SFc1_CoupledTanks_doubletank_boInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_b_emlrt_marshallIn(SFc1_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  int32_T c1_y[15]);
...
static const mxArray *c1_c_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_c_emlrt_marshallIn(SFc1_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance, const mxArray *c1_b_last_emergency_instance, const char_T
  *c1_identifier, real_T c1_y[10]);
static void c1_d_emlrt_marshallIn(SFc1_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[10]);
...
static const mxArray *c1_e_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_g_emlrt_marshallIn(SFc1_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance, const mxArray *c1_b_delay1, const char_T *c1_identifier, real_T
  c1_y[15]);
static void c1_h_emlrt_marshallIn(SFc1_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[15]);
...
static const mxArray *c1_g_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_i_emlrt_marshallIn(SFc1_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance, const mxArray *c1_ymea1, const char_T *c1_identifier, real_T
  c1_y[10]);
static void c1_j_emlrt_marshallIn(SFc1_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[10]);
...
static const mxArray *c1_j_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_l_emlrt_marshallIn(SFc1_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[10]);
static void c1_i_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static void c1_m_emlrt_marshallIn(SFc1_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance, const mxArray *c1_transpose, const char_T *c1_identifier,
  real_T c1_y[15]);
static void c1_n_emlrt_marshallIn(SFc1_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[15]);
static uint8_T c1_o_emlrt_marshallIn
  (SFc1_CoupledTanks_doubletank_boInstanceStruct *chartInstance, const mxArray
   *c1_b_is_active_c1_CoupledTanks_doubletank_bo, const char_T *c1_identifier);
static uint8_T c1_p_emlrt_marshallIn
  (SFc1_CoupledTanks_doubletank_boInstanceStruct *chartInstance, const mxArray
   *c1_u, const emlrtMsgIdentifier *c1_parentId);
static int32_T c1_get_counter_global
  (SFc1_CoupledTanks_doubletank_boInstanceStruct *chartInstance, uint32_T c1_b);
static void c1_set_counter_global(SFc1_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance, uint32_T c1_b, int32_T c1_c);
static int32_T *c1_access_counter_global
  (SFc1_CoupledTanks_doubletank_boInstanceStruct *chartInstance, uint32_T c1_b);
static int32_T c1_get_ydelay_global
  (SFc1_CoupledTanks_doubletank_boInstanceStruct *chartInstance, uint32_T c1_b);
static void c1_set_ydelay_global(SFc1_CoupledTanks_doubletank_boInstanceStruct
  *chartInstance, uint32_T c1_b, int32_T c1_c);
static int32_T *c1_access_ydelay_global
  (SFc1_CoupledTanks_doubletank_boInstanceStruct *chartInstance, uint32_T c1_b);
static void init_dsm_address_info(SFc1_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance);
  ...
  (SFc1_CoupledTanks_doubletank_boInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_CoupledTanks_doubletank_bo = 0U;
}
  ...
  (SFc1_CoupledTanks_doubletank_boInstanceStruct *chartInstance)
{
  ...
  c1_b_hoistedGlobal = chartInstance->c1_is_active_c1_CoupledTanks_doubletank_bo;
   ...
   *c1_st)
{
  ...
  chartInstance->c1_is_active_c1_CoupledTanks_doubletank_bo =
    c1_o_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 5)),
    "is_active_c1_CoupledTanks_doubletank_bo");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_CoupledTanks_doubletank_bo(chartInstance);
  ...
  (SFc1_CoupledTanks_doubletank_boInstanceStruct *chartInstance)
{
  ...
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_CoupledTanks_doubletank_boMachineNumber_,
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_CoupledTanks_doubletank_boInstanceStruct *chartInstance;
  chartInstance = (SFc1_CoupledTanks_doubletank_boInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c1_CoupledTanks_doubletank_bo_get_eml_resolved_functions_info
  (void)
{
   ...
   *c1_b_is_active_c1_CoupledTanks_doubletank_bo, const char_T *c1_identifier)
{
  ...
  c1_y = c1_p_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_CoupledTanks_doubletank_bo), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_CoupledTanks_doubletank_bo);
  return c1_y;
}
...
void sf_c1_CoupledTanks_doubletank_bo_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_CoupledTanks_doubletank_bo_get_autoinheritance_info(void)
{
...
mxArray *sf_c1_CoupledTanks_doubletank_bo_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c1_CoupledTanks_doubletank_bo(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x6'type','srcId','name','auxInfo'{{M[1],M[5],T\"ydelay\",},{M[1],M[7],T\"ymea1\",},{M[4],M[0],T\"delay1\",S'l','i','p'{{M1x2[168 174],M[0],}}},{M[4],M[0],T\"i\",S'l','i','p'{{M1x2[200 201],M[0],}}},{M[4],M[0],T\"last_emergency_instance\",S'l','i','p'{{M1x2[222 245],M[0],}}},{M[8],M[0],T\"is_active_c1_CoupledTanks_doubletank_bo\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 6, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_CoupledTanks_doubletank_bo_get_check_sum(&mxChecksum);
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart
          (sfGlobalDebugInstanceStruct,
           _CoupledTanks_doubletank_boMachineNumber_,
           1,
           1,
           1,
           5,
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _CoupledTanks_doubletank_boMachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
static void sf_opaque_initialize_c1_CoupledTanks_doubletank_bo(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_CoupledTanks_doubletank_boInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_CoupledTanks_doubletank_bo
    ((SFc1_CoupledTanks_doubletank_boInstanceStruct*) chartInstanceVar);
  initialize_c1_CoupledTanks_doubletank_bo
    ((SFc1_CoupledTanks_doubletank_boInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_CoupledTanks_doubletank_bo(void
  *chartInstanceVar)
{
  enable_c1_CoupledTanks_doubletank_bo
    ((SFc1_CoupledTanks_doubletank_boInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_CoupledTanks_doubletank_bo(void
  *chartInstanceVar)
{
  disable_c1_CoupledTanks_doubletank_bo
    ((SFc1_CoupledTanks_doubletank_boInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_CoupledTanks_doubletank_bo(void
  *chartInstanceVar)
{
  sf_c1_CoupledTanks_doubletank_bo
    ((SFc1_CoupledTanks_doubletank_boInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_CoupledTanks_doubletank_bo
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_CoupledTanks_doubletank_bo
    ((SFc1_CoupledTanks_doubletank_boInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_CoupledTanks_doubletank_bo();/* state var info */
...
extern void sf_internal_set_sim_state_c1_CoupledTanks_doubletank_bo(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c1_CoupledTanks_doubletank_bo
    ((SFc1_CoupledTanks_doubletank_boInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_CoupledTanks_doubletank_bo
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c1_CoupledTanks_doubletank_bo(S);
}

static void sf_opaque_set_sim_state_c1_CoupledTanks_doubletank_bo(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c1_CoupledTanks_doubletank_bo(S, st);
}

static void sf_opaque_terminate_c1_CoupledTanks_doubletank_bo(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_CoupledTanks_doubletank_boInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_CoupledTanks_doubletank_bo_optimization_info();
    }

    finalize_c1_CoupledTanks_doubletank_bo
      ((SFc1_CoupledTanks_doubletank_boInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_CoupledTanks_doubletank_bo
    ((SFc1_CoupledTanks_doubletank_boInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_CoupledTanks_doubletank_bo(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c1_CoupledTanks_doubletank_bo
      ((SFc1_CoupledTanks_doubletank_boInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c1_CoupledTanks_doubletank_bo(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_CoupledTanks_doubletank_bo_optimization_info();
...
static void mdlRTW_c1_CoupledTanks_doubletank_bo(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_CoupledTanks_doubletank_bo(SimStruct *S)
{
  SFc1_CoupledTanks_doubletank_boInstanceStruct *chartInstance;
  chartInstance = (SFc1_CoupledTanks_doubletank_boInstanceStruct *)utMalloc
    (sizeof(SFc1_CoupledTanks_doubletank_boInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_CoupledTanks_doubletank_boInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_CoupledTanks_doubletank_bo;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_CoupledTanks_doubletank_bo;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_CoupledTanks_doubletank_bo;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c1_CoupledTanks_doubletank_bo;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c1_CoupledTanks_doubletank_bo;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_CoupledTanks_doubletank_bo;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_CoupledTanks_doubletank_bo;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_CoupledTanks_doubletank_bo;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_CoupledTanks_doubletank_bo;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_CoupledTanks_doubletank_bo;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_CoupledTanks_doubletank_bo;
...
void c1_CoupledTanks_doubletank_bo_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_CoupledTanks_doubletank_bo(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_CoupledTanks_doubletank_bo(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_CoupledTanks_doubletank_bo(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_CoupledTanks_doubletank_bo_method_dispatcher.\n"
