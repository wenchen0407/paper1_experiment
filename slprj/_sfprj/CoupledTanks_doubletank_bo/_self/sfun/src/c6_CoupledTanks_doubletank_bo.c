...
#include "c6_CoupledTanks_doubletank_bo.h"
...
static void initialize_c6_CoupledTanks_doubletank_bo
  (SFc6_CoupledTanks_doubletank_boInstanceStruct *chartInstance);
static void initialize_params_c6_CoupledTanks_doubletank_bo
  (SFc6_CoupledTanks_doubletank_boInstanceStruct *chartInstance);
static void enable_c6_CoupledTanks_doubletank_bo
  (SFc6_CoupledTanks_doubletank_boInstanceStruct *chartInstance);
static void disable_c6_CoupledTanks_doubletank_bo
  (SFc6_CoupledTanks_doubletank_boInstanceStruct *chartInstance);
static void c6_update_debugger_state_c6_CoupledTanks_doubletank_bo
  (SFc6_CoupledTanks_doubletank_boInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c6_CoupledTanks_doubletank_bo
  (SFc6_CoupledTanks_doubletank_boInstanceStruct *chartInstance);
static void set_sim_state_c6_CoupledTanks_doubletank_bo
  (SFc6_CoupledTanks_doubletank_boInstanceStruct *chartInstance, const mxArray
   *c6_st);
static void finalize_c6_CoupledTanks_doubletank_bo
  (SFc6_CoupledTanks_doubletank_boInstanceStruct *chartInstance);
static void sf_c6_CoupledTanks_doubletank_bo
  (SFc6_CoupledTanks_doubletank_boInstanceStruct *chartInstance);
static void initSimStructsc6_CoupledTanks_doubletank_bo
  (SFc6_CoupledTanks_doubletank_boInstanceStruct *chartInstance);
static void registerMessagesc6_CoupledTanks_doubletank_bo
  (SFc6_CoupledTanks_doubletank_boInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c6_machineNumber, uint32_T
  c6_chartNumber);
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData);
static real_T c6_emlrt_marshallIn(SFc6_CoupledTanks_doubletank_boInstanceStruct *
...
static const mxArray *c6_b_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static void c6_c_emlrt_marshallIn(SFc6_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance, const mxArray *c6_b_uin_all, const char_T *c6_identifier,
  real_T c6_y[1600002]);
static void c6_d_emlrt_marshallIn(SFc6_CoupledTanks_doubletank_boInstanceStruct *
...
static const mxArray *c6_c_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static void c6_e_emlrt_marshallIn(SFc6_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance, const mxArray *c6_b_delay, const char_T *c6_identifier, real_T
  c6_y[15]);
static void c6_f_emlrt_marshallIn(SFc6_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId,
  real_T c6_y[15]);
...
static const mxArray *c6_d_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static void c6_g_emlrt_marshallIn(SFc6_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance, const mxArray *c6_b_uin, const char_T *c6_identifier, real_T
  c6_y[2]);
static void c6_h_emlrt_marshallIn(SFc6_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId,
  real_T c6_y[2]);
...
static const mxArray *c6_e_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static void c6_i_emlrt_marshallIn(SFc6_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance, const mxArray *c6_b_uin_d, const char_T *c6_identifier, real_T
  c6_y[2]);
static void c6_j_emlrt_marshallIn(SFc6_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId,
  real_T c6_y[2]);
...
static const mxArray *c6_f_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static void c6_k_emlrt_marshallIn(SFc6_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance, const mxArray *c6_uout_delay, const char_T *c6_identifier,
  real_T c6_y[2]);
static void c6_l_emlrt_marshallIn(SFc6_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId,
  real_T c6_y[2]);
...
static uint8_T c6_o_emlrt_marshallIn
  (SFc6_CoupledTanks_doubletank_boInstanceStruct *chartInstance, const mxArray
   *c6_b_is_active_c6_CoupledTanks_doubletank_bo, const char_T *c6_identifier);
static uint8_T c6_p_emlrt_marshallIn
  (SFc6_CoupledTanks_doubletank_boInstanceStruct *chartInstance, const mxArray
   *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void init_dsm_address_info(SFc6_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance);
  ...
  (SFc6_CoupledTanks_doubletank_boInstanceStruct *chartInstance)
{
  ...
  chartInstance->c6_is_active_c6_CoupledTanks_doubletank_bo = 0U;
}
  ...
  (SFc6_CoupledTanks_doubletank_boInstanceStruct *chartInstance)
{
  ...
  c6_b_hoistedGlobal = chartInstance->c6_is_active_c6_CoupledTanks_doubletank_bo;
   ...
   *c6_st)
{
  ...
  chartInstance->c6_is_active_c6_CoupledTanks_doubletank_bo =
    c6_o_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c6_u, 6)),
    "is_active_c6_CoupledTanks_doubletank_bo");
  sf_mex_destroy(&c6_u);
  c6_update_debugger_state_c6_CoupledTanks_doubletank_bo(chartInstance);
...
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData)
{
  ...
  const mxArray *c6_y = NULL;
  SFc6_CoupledTanks_doubletank_boInstanceStruct *chartInstance;
  chartInstance = (SFc6_CoupledTanks_doubletank_boInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c6_CoupledTanks_doubletank_bo_get_eml_resolved_functions_info
  (void)
{
   ...
   *c6_b_is_active_c6_CoupledTanks_doubletank_bo, const char_T *c6_identifier)
{
  ...
  c6_y = c6_p_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c6_b_is_active_c6_CoupledTanks_doubletank_bo), &c6_thisId);
  sf_mex_destroy(&c6_b_is_active_c6_CoupledTanks_doubletank_bo);
  return c6_y;
}
...
void sf_c6_CoupledTanks_doubletank_bo_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c6_CoupledTanks_doubletank_bo_get_autoinheritance_info(void)
{
...
mxArray *sf_c6_CoupledTanks_doubletank_bo_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c6_CoupledTanks_doubletank_bo(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x7'type','srcId','name','auxInfo'{{M[1],M[5],T\"uout_delay\",},{M[4],M[0],T\"delay\",S'l','i','p'{{M1x2[323 328],M[0],}}},{M[4],M[0],T\"numAct\",S'l','i','p'{{M1x2[337 343],M[0],}}},{M[4],M[0],T\"uin\",S'l','i','p'{{M1x2[319 322],M[0],}}},{M[4],M[0],T\"uin_all\",S'l','i','p'{{M1x2[329 336],M[0],}}},{M[4],M[0],T\"uin_d\",S'l','i','p'{{M1x2[301 306],M[0],}}},{M[8],M[0],T\"is_active_c6_CoupledTanks_doubletank_bo\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 7, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c6_CoupledTanks_doubletank_bo_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c6_CoupledTanks_doubletank_bo(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc6_CoupledTanks_doubletank_boInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c6_CoupledTanks_doubletank_bo
    ((SFc6_CoupledTanks_doubletank_boInstanceStruct*) chartInstanceVar);
  initialize_c6_CoupledTanks_doubletank_bo
    ((SFc6_CoupledTanks_doubletank_boInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c6_CoupledTanks_doubletank_bo(void
  *chartInstanceVar)
{
  enable_c6_CoupledTanks_doubletank_bo
    ((SFc6_CoupledTanks_doubletank_boInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c6_CoupledTanks_doubletank_bo(void
  *chartInstanceVar)
{
  disable_c6_CoupledTanks_doubletank_bo
    ((SFc6_CoupledTanks_doubletank_boInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c6_CoupledTanks_doubletank_bo(void
  *chartInstanceVar)
{
  sf_c6_CoupledTanks_doubletank_bo
    ((SFc6_CoupledTanks_doubletank_boInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c6_CoupledTanks_doubletank_bo
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c6_CoupledTanks_doubletank_bo
    ((SFc6_CoupledTanks_doubletank_boInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c6_CoupledTanks_doubletank_bo();/* state var info */
...
extern void sf_internal_set_sim_state_c6_CoupledTanks_doubletank_bo(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c6_CoupledTanks_doubletank_bo
    ((SFc6_CoupledTanks_doubletank_boInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c6_CoupledTanks_doubletank_bo
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c6_CoupledTanks_doubletank_bo(S);
}

static void sf_opaque_set_sim_state_c6_CoupledTanks_doubletank_bo(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c6_CoupledTanks_doubletank_bo(S, st);
}

static void sf_opaque_terminate_c6_CoupledTanks_doubletank_bo(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc6_CoupledTanks_doubletank_boInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c6_CoupledTanks_doubletank_bo
      ((SFc6_CoupledTanks_doubletank_boInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc6_CoupledTanks_doubletank_bo
    ((SFc6_CoupledTanks_doubletank_boInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c6_CoupledTanks_doubletank_bo(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c6_CoupledTanks_doubletank_bo
      ((SFc6_CoupledTanks_doubletank_boInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c6_CoupledTanks_doubletank_bo(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c6_CoupledTanks_doubletank_bo(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c6_CoupledTanks_doubletank_bo(SimStruct *S)
{
  SFc6_CoupledTanks_doubletank_boInstanceStruct *chartInstance;
  chartInstance = (SFc6_CoupledTanks_doubletank_boInstanceStruct *)utMalloc
    (sizeof(SFc6_CoupledTanks_doubletank_boInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc6_CoupledTanks_doubletank_boInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c6_CoupledTanks_doubletank_bo;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c6_CoupledTanks_doubletank_bo;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c6_CoupledTanks_doubletank_bo;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c6_CoupledTanks_doubletank_bo;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c6_CoupledTanks_doubletank_bo;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c6_CoupledTanks_doubletank_bo;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c6_CoupledTanks_doubletank_bo;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c6_CoupledTanks_doubletank_bo;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c6_CoupledTanks_doubletank_bo;
  chartInstance->chartInfo.mdlStart = mdlStart_c6_CoupledTanks_doubletank_bo;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c6_CoupledTanks_doubletank_bo;
...
void c6_CoupledTanks_doubletank_bo_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c6_CoupledTanks_doubletank_bo(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c6_CoupledTanks_doubletank_bo(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c6_CoupledTanks_doubletank_bo(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c6_CoupledTanks_doubletank_bo_method_dispatcher.\n"
