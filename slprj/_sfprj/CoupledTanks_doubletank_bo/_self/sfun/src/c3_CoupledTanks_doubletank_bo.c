...
#include "c3_CoupledTanks_doubletank_bo.h"
...
static void initialize_c3_CoupledTanks_doubletank_bo
  (SFc3_CoupledTanks_doubletank_boInstanceStruct *chartInstance);
static void initialize_params_c3_CoupledTanks_doubletank_bo
  (SFc3_CoupledTanks_doubletank_boInstanceStruct *chartInstance);
static void enable_c3_CoupledTanks_doubletank_bo
  (SFc3_CoupledTanks_doubletank_boInstanceStruct *chartInstance);
static void disable_c3_CoupledTanks_doubletank_bo
  (SFc3_CoupledTanks_doubletank_boInstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_CoupledTanks_doubletank_bo
  (SFc3_CoupledTanks_doubletank_boInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_CoupledTanks_doubletank_bo
  (SFc3_CoupledTanks_doubletank_boInstanceStruct *chartInstance);
static void set_sim_state_c3_CoupledTanks_doubletank_bo
  (SFc3_CoupledTanks_doubletank_boInstanceStruct *chartInstance, const mxArray
   *c3_st);
static void finalize_c3_CoupledTanks_doubletank_bo
  (SFc3_CoupledTanks_doubletank_boInstanceStruct *chartInstance);
static void sf_c3_CoupledTanks_doubletank_bo
  (SFc3_CoupledTanks_doubletank_boInstanceStruct *chartInstance);
static void c3_chartstep_c3_CoupledTanks_doubletank_bo
  (SFc3_CoupledTanks_doubletank_boInstanceStruct *chartInstance);
static void initSimStructsc3_CoupledTanks_doubletank_bo
  (SFc3_CoupledTanks_doubletank_boInstanceStruct *chartInstance);
static void registerMessagesc3_CoupledTanks_doubletank_bo
  (SFc3_CoupledTanks_doubletank_boInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static real_T c3_emlrt_marshallIn(SFc3_CoupledTanks_doubletank_boInstanceStruct *
...
static const mxArray *c3_b_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_c_emlrt_marshallIn(SFc3_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance, const mxArray *c3_b_yin_all, const char_T *c3_identifier,
  real_T c3_y[4000005]);
static void c3_d_emlrt_marshallIn(SFc3_CoupledTanks_doubletank_boInstanceStruct *
...
static void c3_e_emlrt_marshallIn(SFc3_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance, const mxArray *c3_delay, const char_T *c3_identifier, real_T
  c3_y_data[15], int32_T c3_y_sizes[2]);
static void c3_f_emlrt_marshallIn(SFc3_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
...
static const mxArray *c3_d_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_g_emlrt_marshallIn(SFc3_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance, const mxArray *c3_b_yin, const char_T *c3_identifier, real_T
  c3_y[5]);
static void c3_h_emlrt_marshallIn(SFc3_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  real_T c3_y[5]);
...
static const mxArray *c3_e_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_i_emlrt_marshallIn(SFc3_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance, const mxArray *c3_b_yin_d, const char_T *c3_identifier, real_T
  c3_y[5]);
static void c3_j_emlrt_marshallIn(SFc3_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  real_T c3_y[5]);
...
static const mxArray *c3_g_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_m_emlrt_marshallIn(SFc3_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance, const mxArray *c3_yout_delay, const char_T *c3_identifier,
  real_T c3_y[5]);
static void c3_n_emlrt_marshallIn(SFc3_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  real_T c3_y[5]);
...
static const mxArray *c3_h_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_o_emlrt_marshallIn(SFc3_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  c3_struct_WeKnf7Jk8GwbDfKwFHL9aD *c3_y);
static real_T c3_p_emlrt_marshallIn
  (SFc3_CoupledTanks_doubletank_boInstanceStruct *chartInstance, const mxArray
   *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_q_emlrt_marshallIn(SFc3_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  real_T c3_y[5]);
static void c3_r_emlrt_marshallIn(SFc3_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  real_T c3_y[5]);
static void c3_s_emlrt_marshallIn(SFc3_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  real_T c3_y[306]);
...
static uint8_T c3_u_emlrt_marshallIn
  (SFc3_CoupledTanks_doubletank_boInstanceStruct *chartInstance, const mxArray
   *c3_b_is_active_c3_CoupledTanks_doubletank_bo, const char_T *c3_identifier);
static uint8_T c3_v_emlrt_marshallIn
  (SFc3_CoupledTanks_doubletank_boInstanceStruct *chartInstance, const mxArray
   *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void init_dsm_address_info(SFc3_CoupledTanks_doubletank_boInstanceStruct *
  chartInstance);
  ...
  (SFc3_CoupledTanks_doubletank_boInstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_CoupledTanks_doubletank_bo = 0U;
}
  ...
  (SFc3_CoupledTanks_doubletank_boInstanceStruct *chartInstance)
{
  ...
  c3_struct_WeKnf7Jk8GwbDfKwFHL9aD c3_r0;
  ...
  (SFc3_CoupledTanks_doubletank_boInstanceStruct *chartInstance)
{
  ...
  c3_c_hoistedGlobal = chartInstance->c3_is_active_c3_CoupledTanks_doubletank_bo;
   ...
   *c3_st)
{
  ...
  chartInstance->c3_is_active_c3_CoupledTanks_doubletank_bo =
    c3_u_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 7)),
    "is_active_c3_CoupledTanks_doubletank_bo");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_CoupledTanks_doubletank_bo(chartInstance);
  ...
  (SFc3_CoupledTanks_doubletank_boInstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_sfEvent = CALL_EVENT;
  c3_chartstep_c3_CoupledTanks_doubletank_bo(chartInstance);
  ...
  (SFc3_CoupledTanks_doubletank_boInstanceStruct *chartInstance)
{
  ...
  int32_T c3_i16;
  real_T c3_ydelay[15];
  c3_struct_WeKnf7Jk8GwbDfKwFHL9aD c3_b_structure;
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_CoupledTanks_doubletank_boInstanceStruct *chartInstance;
  chartInstance = (SFc3_CoupledTanks_doubletank_boInstanceStruct *)
    chartInstanceVoid;
...
{
  const mxArray *c3_mxArrayOutData = NULL;
  c3_struct_WeKnf7Jk8GwbDfKwFHL9aD c3_u;
  const mxArray *c3_y = NULL;
  real_T c3_b_u;
  const mxArray *c3_b_y = NULL;
  real_T c3_c_u;
  ...
  chartInstance = (SFc3_CoupledTanks_doubletank_boInstanceStruct *)
    chartInstanceVoid;
  c3_mxArrayOutData = NULL;
  c3_u = *(c3_struct_WeKnf7Jk8GwbDfKwFHL9aD *)c3_inData;
  c3_y = NULL;
  ...
  for (c3_i69 = 0; c3_i69 < 306; c3_i69++) {
    c3_f_u[c3_i69] = c3_u.delay1[c3_i69];
  }

  c3_f_y = NULL;
  sf_mex_assign(&c3_f_y, sf_mex_create("y", c3_f_u, 0, 0U, 1U, 0U, 2, 51, 6),
                FALSE);
  ...
  real_T c3_y[306])
{
  real_T c3_dv12[306];
  int32_T c3_i73;
  sf_mex_import(c3_parentId, sf_mex_dup(c3_u), c3_dv12, 1, 0, 0U, 1, 0U, 2, 51,
                6);
  for (c3_i73 = 0; c3_i73 < 306; c3_i73++) {
  ...
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  ...
  *(c3_struct_WeKnf7Jk8GwbDfKwFHL9aD *)c3_outData = c3_y;
  sf_mex_destroy(&c3_mxArrayInData);
}
...
const mxArray *sf_c3_CoupledTanks_doubletank_bo_get_eml_resolved_functions_info
  (void)
{
   ...
   *c3_b_is_active_c3_CoupledTanks_doubletank_bo, const char_T *c3_identifier)
{
  ...
  c3_y = c3_v_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_CoupledTanks_doubletank_bo), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_CoupledTanks_doubletank_bo);
  return c3_y;
}
...
void sf_c3_CoupledTanks_doubletank_bo_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(344800274U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1965632577U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4249421985U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3649386739U);
}

mxArray *sf_c3_CoupledTanks_doubletank_bo_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("pjxQDz45PgcAuC6gg5PhNF");
...
mxArray *sf_c3_CoupledTanks_doubletank_bo_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c3_CoupledTanks_doubletank_bo(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x8'type','srcId','name','auxInfo'{{M[1],M[5],T\"yout_delay\",},{M[4],M[0],T\"delay\",S'l','i','p'{{M1x2[332 337],M[0],}}},{M[4],M[0],T\"i\",S'l','i','p'{{M1x2[308 309],M[0],}}},{M[4],M[0],T\"num\",S'l','i','p'{{M1x2[346 349],M[0],}}},{M[4],M[0],T\"yin\",S'l','i','p'{{M1x2[328 331],M[0],}}},{M[4],M[0],T\"yin_all\",S'l','i','p'{{M1x2[338 345],M[0],}}},{M[4],M[0],T\"yin_d\",S'l','i','p'{{M1x2[310 315],M[0],}}},{M[8],M[0],T\"is_active_c3_CoupledTanks_doubletank_bo\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 8, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_CoupledTanks_doubletank_bo_get_check_sum(&mxChecksum);
...
{
  return "ONnZP4pOa0G0zyHa8HbrKB";
}

static void sf_opaque_initialize_c3_CoupledTanks_doubletank_bo(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_CoupledTanks_doubletank_boInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_CoupledTanks_doubletank_bo
    ((SFc3_CoupledTanks_doubletank_boInstanceStruct*) chartInstanceVar);
  initialize_c3_CoupledTanks_doubletank_bo
    ((SFc3_CoupledTanks_doubletank_boInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c3_CoupledTanks_doubletank_bo(void
  *chartInstanceVar)
{
  enable_c3_CoupledTanks_doubletank_bo
    ((SFc3_CoupledTanks_doubletank_boInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c3_CoupledTanks_doubletank_bo(void
  *chartInstanceVar)
{
  disable_c3_CoupledTanks_doubletank_bo
    ((SFc3_CoupledTanks_doubletank_boInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c3_CoupledTanks_doubletank_bo(void
  *chartInstanceVar)
{
  sf_c3_CoupledTanks_doubletank_bo
    ((SFc3_CoupledTanks_doubletank_boInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_CoupledTanks_doubletank_bo
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_CoupledTanks_doubletank_bo
    ((SFc3_CoupledTanks_doubletank_boInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_CoupledTanks_doubletank_bo();/* state var info */
...
extern void sf_internal_set_sim_state_c3_CoupledTanks_doubletank_bo(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c3_CoupledTanks_doubletank_bo
    ((SFc3_CoupledTanks_doubletank_boInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_CoupledTanks_doubletank_bo
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c3_CoupledTanks_doubletank_bo(S);
}

static void sf_opaque_set_sim_state_c3_CoupledTanks_doubletank_bo(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c3_CoupledTanks_doubletank_bo(S, st);
}

static void sf_opaque_terminate_c3_CoupledTanks_doubletank_bo(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_CoupledTanks_doubletank_boInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c3_CoupledTanks_doubletank_bo
      ((SFc3_CoupledTanks_doubletank_boInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc3_CoupledTanks_doubletank_bo
    ((SFc3_CoupledTanks_doubletank_boInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_CoupledTanks_doubletank_bo(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c3_CoupledTanks_doubletank_bo
      ((SFc3_CoupledTanks_doubletank_boInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c3_CoupledTanks_doubletank_bo(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2446182822U));
  ssSetChecksum1(S,(1959054363U));
  ssSetChecksum2(S,(424998990U));
  ssSetChecksum3(S,(654216087U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c3_CoupledTanks_doubletank_bo(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_CoupledTanks_doubletank_bo(SimStruct *S)
{
  SFc3_CoupledTanks_doubletank_boInstanceStruct *chartInstance;
  chartInstance = (SFc3_CoupledTanks_doubletank_boInstanceStruct *)utMalloc
    (sizeof(SFc3_CoupledTanks_doubletank_boInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_CoupledTanks_doubletank_boInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_CoupledTanks_doubletank_bo;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_CoupledTanks_doubletank_bo;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_CoupledTanks_doubletank_bo;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c3_CoupledTanks_doubletank_bo;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c3_CoupledTanks_doubletank_bo;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_CoupledTanks_doubletank_bo;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_CoupledTanks_doubletank_bo;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_CoupledTanks_doubletank_bo;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_CoupledTanks_doubletank_bo;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_CoupledTanks_doubletank_bo;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_CoupledTanks_doubletank_bo;
...
void c3_CoupledTanks_doubletank_bo_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_CoupledTanks_doubletank_bo(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_CoupledTanks_doubletank_bo(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_CoupledTanks_doubletank_bo(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_CoupledTanks_doubletank_bo_method_dispatcher.\n"
